...
function CraftSim.ProfessionStats:GetTooltipText(maxProfessionStats)
	...
	local text =
		...
		((maxProfessionStats.ingenuity.extraFactor > 0 and (CraftSim.LOCAL:GetText(CraftSim.CONST.TEXT.STAT_INGENUITY_BONUS) .. ": " .. r(self.ingenuity.extraFactor * 100) .. "%" .. " / " .. f.grey(r(maxProfessionStats.ingenuity.extraFactor * 100) .. "%") .. "\n")) or "") ..
