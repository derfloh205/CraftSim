...
--- workaround to use quality item ids because of issues with GetRecipeOutputItemData API 
    elseif recipeData.supportsQualities and not recipeData.isSalvageRecipe and not recipeData.isGatheringRecipe then
