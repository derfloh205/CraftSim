...
local print = CraftSim.DEBUG:SetDebugPrint("Classes.RecipeData.ReagentData")
...
function CraftSim.ReagentData:GetCraftableAmount(crafterUID)
    local print = CraftSim.DEBUG:SetDebugPrint("Classes.RecipeData.ReagentData.GetCraftableAmount")
...
function CraftSim.ReagentData:GetTooltipText(multiplier, crafterUID)
    local print = CraftSim.DEBUG:SetDebugPrint("Classes.RecipeData.ReagentData.GetTooltipText")
    multiplier = multiplier or 1
    local iconSize = 25
    local text = ""
