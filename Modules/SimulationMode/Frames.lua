...
function CraftSim.SIMULATION_MODE.FRAMES:Init()
    ...
    local function createSimulationModeFrames(schematicForm, workOrder)
        ...
        local simModeDetailsFrame = CraftSim.FRAME:CreateCraftSimFrame(
            ...
            350, 
            355, 
            (workOrder and CraftSim.CONST.FRAMES.CRAFTING_DETAILS_WO) or CraftSim.CONST.FRAMES.CRAFTING_DETAILS)
...
function CraftSim.SIMULATION_MODE.FRAMES:UpdateVisibility()
    ...
    if exportMode == CraftSim.CONST.EXPORT_MODE.WORK_ORDER then
        ...
        specializationInfoFrame = CraftSim.FRAME:GetFrame(CraftSim.CONST.FRAMES.SPEC_INFO_WO)
        ...
        specializationInfoFrame = CraftSim.FRAME:GetFrame(CraftSim.CONST.FRAMES.SPEC_INFO)
    end
