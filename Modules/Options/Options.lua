...
function CraftSim.OPTIONS:Init()
    ...
    proxyBool("CraftSimOpt_GEAR_CHEAPEST_QUALITY", GO.PROFIT_CALCULATION_GEAR_CHEAPEST_QUALITY_PRICE,
        L("OPTIONS_PROFIT_CALCULATION_GEAR_CHEAPEST_QUALITY"),
        L("OPTIONS_PROFIT_CALCULATION_GEAR_CHEAPEST_QUALITY_TOOLTIP"))
