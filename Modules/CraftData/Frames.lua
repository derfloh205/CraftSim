...
function CraftSim.CRAFTDATA.FRAMES:Init()
    ...
    CraftSim.GGUI.HelpIcon({
        parent = craftDataFrame.content,
        anchorParent = craftDataFrame.title.frame,
        anchorA = "LEFT",
        anchorB = "RIGHT",
        offsetX = 5,
        text = CraftSim.LOCAL:GetText(CraftSim.CONST.TEXT.CRAFT_DATA_EXPLANATION)
    })
    ...
    craftDataFrame.content.clearDataAll = CraftSim.GGUI.Button({
        parent = craftDataFrame.content,
        anchorParent = craftDataFrame.content,
        anchorA = "TOPLEFT",
        anchorB = "TOPLEFT",
    ...
    craftDataFrame.content.clearDataRecipe = CraftSim.GGUI.Button({
        parent = craftDataFrame.content,
        anchorParent = craftDataFrame.content.clearDataAll.frame,
        anchorA = "TOPLEFT",
        anchorB = "BOTTOMLEFT",
        label = CraftSim.LOCAL:GetText(CraftSim.CONST.TEXT.CRAFT_DATA_DELETE_RECIPE),
        adjustWidth = true,
        clickCallback = function()
    ...
    craftDataFrame.expandListButton = CraftSim.GGUI.Button({
        parent = craftDataFrame.content,
        anchorParent = craftDataFrame.frame,
        anchorA = "BOTTOM",
        anchorB = "BOTTOM",
    ...
    dataFrame.crafterTitle = CraftSim.GGUI.Text({
        parent = dataFrame,
        anchorParent = dataFrame.itemIcon.frame,
        anchorA = "TOPLEFT",
        anchorB = "TOPRIGHT",
        offsetX = 15,
        offsetY = 3,
        text = CraftSim.LOCAL:GetText(CraftSim.CONST.TEXT.CRAFT_DATA_CRAFTER),
        justifyOptions = { type = "H", align = "LEFT" },
    })
    ---@type GGUI.Text | GGUI.Widget
    dataFrame.crafterValue = CraftSim.GGUI.Text({
        parent = dataFrame,
        anchorParent = dataFrame.crafterTitle.frame,
        anchorA = "LEFT",
        anchorB = "RIGHT",
        offsetX = 5,
        text = 1,
    ...
    dataFrame.expectedCraftsTitle = CraftSim.GGUI.Text({
        ...
        anchorA = "TOPLEFT",
        anchorB = "BOTTOMLEFT",
        offsetY = sideTextSpacing,
        text = CraftSim.LOCAL:GetText(CraftSim.CONST.TEXT.CRAFT_DATA_EXPECTED_CRAFTS),
        justifyOptions = { type = "H", align = "LEFT" },
    })
    ---@type GGUI.Text | GGUI.Widget
    dataFrame.expectedCraftsValue = CraftSim.GGUI.Text({
        parent = dataFrame,
        anchorParent = dataFrame.expectedCraftsTitle.frame,
        anchorA = "LEFT",
        anchorB = "RIGHT",
        offsetX = 5,
        text = 1,
    ...
    CraftSim.GGUI.HelpIcon({
        parent = dataFrame,
        anchorParent = dataFrame.expectedCraftsValue.frame,
        anchorA = "LEFT",
        anchorB = "RIGHT",
        offsetX = 5,
        text = CraftSim.LOCAL:GetText(CraftSim.CONST.TEXT.CRAFT_DATA_EXPECTED_CRAFTS_EXPLANATION)
    })
    ...
    dataFrame.chanceTitle = CraftSim.GGUI.Text({
        ...
        anchorB = "BOTTOMLEFT",
        offsetY = sideTextSpacing,
        text = CraftSim.LOCAL:GetText(CraftSim.CONST.TEXT.CRAFT_DATA_CRAFTING_CHANCE),
        justifyOptions = { type = "H", align = "LEFT" },
    })
    ...
    dataFrame.chanceValue = CraftSim.GGUI.Text({
        parent = dataFrame,
        anchorParent = dataFrame.chanceTitle.frame,
        anchorA = "LEFT",
        anchorB = "RIGHT",
        offsetX = 5,
        text = "100%",
    ...
    CraftSim.GGUI.HelpIcon({
        parent = dataFrame,
        anchorParent = dataFrame.chanceValue.frame,
        anchorA = "LEFT",
        anchorB = "RIGHT",
        offsetX = 5,
        text = CraftSim.LOCAL:GetText(CraftSim.CONST.TEXT.CRAFT_DATA_UPGRADE_CHANCE_EXPLANATION)
    })
    ...
    dataFrame.expectedCostsTitle = CraftSim.GGUI.Text({
        ...
        anchorB = "BOTTOMLEFT",
        offsetY = sideTextSpacing,
        text = CraftSim.LOCAL:GetText(CraftSim.CONST.TEXT.CRAFT_DATA_EXPECTED_COSTS),
        justifyOptions = { type = "H", align = "LEFT" },
    })
    ---@type GGUI.Text | GGUI.Widget
    dataFrame.expectedCostsValue = CraftSim.GGUI.Text({
        parent = dataFrame,
        anchorParent = dataFrame.expectedCostsTitle.frame,
        anchorA = "LEFT",
        anchorB = "RIGHT",
        offsetX = 5,
        text = CraftSim.GUTIL:FormatMoney(1234567000),
        justifyOptions = { type = "H", align = "LEFT" },
    })

    CraftSim.GGUI.HelpIcon({
        parent = dataFrame,
        anchorParent = dataFrame.expectedCostsValue.frame,
        anchorA = "LEFT",
        anchorB = "RIGHT",
        offsetX = 5,
        text = CraftSim.LOCAL:GetText(CraftSim.CONST.TEXT.CRAFT_DATA_EXPECTED_COSTS_EXPLANATION)
    })
    ...
    dataFrame.minimumCostsTitle = CraftSim.GGUI.Text({
        ...
        anchorB = "BOTTOMLEFT",
        offsetY = sideTextSpacing,
        text = CraftSim.LOCAL:GetText(CraftSim.CONST.TEXT.CRAFT_DATA_MINIMUM_COST),
        justifyOptions = { type = "H", align = "LEFT" },
    })
    ---@type GGUI.Text | GGUI.Widget
    dataFrame.minimumCostsValue = CraftSim.GGUI.Text({
        parent = dataFrame,
        anchorParent = dataFrame.minimumCostsTitle.frame,
        anchorA = "LEFT",
        anchorB = "RIGHT",
        offsetX = 5,
        text = CraftSim.GUTIL:FormatMoney(1234567000),
    ...
    dataFrame.deleteCraftDataButton = CraftSim.GGUI.Button({
        parent = dataFrame,
        anchorParent = dataFrame.saveButton.frame,
        anchorA = "LEFT",
        anchorB = "RIGHT",
        label = CraftSim.LOCAL:GetText(CraftSim.CONST.TEXT.CRAFT_DATA_DELETE),
        adjustWidth = true,
        clickCallback = function()
            local selectedItem = craftDataFrame.content.resultsDropdown.selectedValue
            if selectedItem then
    ...
    dataFrame.savedConfigurationTitle = CraftSim.GGUI.Text({
        ...
        anchorA = "TOP",
        anchorB = "TOP",
        text = CraftSim.LOCAL:GetText(CraftSim.CONST.TEXT.CRAFT_DATA_SAVED_MATERIALS),
        offsetY = -120
    })
    ---@type GGUI.Text | GGUI.Widget
    dataFrame.noDataText = CraftSim.GGUI.Text({
        ...
        anchorA = "TOP",
        anchorB = "TOP",
        text = CraftSim.GUTIL:ColorizeText(CraftSim.LOCAL:GetText(CraftSim.CONST.TEXT.CRAFT_DATA_NO_DATA),
    ...
    local function createReagentFrame(anchorA, anchorParent, anchorB, anchorX, anchorY)
        ...
        reagentFrame.countTextNoQ = CraftSim.GGUI.Text({
            parent = reagentFrame,
            anchorParent = reagentFrame.icon.frame,
            anchorA = "LEFT",
            anchorB = "RIGHT",
            offsetX = 5,
            scale = 0.9,
    ...
    dataFrame.reagentFrames = {
        ...
        createReagentFrame("TOPLEFT", dataFrame.savedConfigurationTitle.frame, "BOTTOMLEFT", baseX + spacingX,
            baseY + spacingY),
        createReagentFrame("TOPLEFT", dataFrame.savedConfigurationTitle.frame, "BOTTOMLEFT", baseX + spacingX * 2,
            baseY + spacingY),
    }
    ...
    dataFrame.optionalReagentsTitle = CraftSim.GGUI.Text({
        parent = dataFrame,
        anchorParent = dataFrame.noDataText.frame,
        anchorA = "TOP",
        anchorB = "BOTTOM",
        offsetY = -90,
    ...
    local function creationOptionalReagentIcon(offsetX)
        return CraftSim.GGUI.Icon({
            parent = dataFrame,
            anchorParent = dataFrame.optionalReagentsTitle.frame,
            anchorA = "TOP",
            anchorB = "BOTTOM",
            offsetY = -10,
            offsetX = offsetX,
    ...
    expandFrame.dataList = CraftSim.GGUI.FrameList({
        ...
        rowConstructor = function(columns)
            ...
            expectedCostColumn.text = CraftSim.GGUI.Text({
                parent = expectedCostColumn,
                anchorParent = expectedCostColumn,
                text = CraftSim.GUTIL:FormatMoney(10000000),
                justifyOptions = { type = "H", align = "LEFT" },
            ...
            loadButtonColumn.loadButton = CraftSim.GGUI.Button({
                parent = loadButtonColumn,
                anchorParent = loadButtonColumn,
                label = "Load",
                sizeX = 60,
            ...
            deleteButtonColumn.deleteButton = CraftSim.GGUI.Button({
                parent = deleteButtonColumn,
                anchorParent = deleteButtonColumn,
    ...
    dataFrame.sendDataInput = CraftSim.GGUI.TextInput({
        parent = dataFrame,
        anchorParent = dataFrame.deleteCraftDataButton.frame,
        sizeX = 100,
        anchorA = "LEFT",
        anchorB = "RIGHT",
        offsetX = 10,
    ...
    dataFrame.sendDataButton = CraftSim.GGUI.Button({
        parent = dataFrame,
        anchorParent = dataFrame.sendDataInput.frame,
        anchorA = "LEFT",
        anchorB = "RIGHT",
        label = CraftSim.LOCAL:GetText(CraftSim.CONST.TEXT.CRAFT_DATA_SEND),
        adjustWidth = true,
        clickCallback = function()
