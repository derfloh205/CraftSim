...
local Logger = CraftSim.DEBUG:RegisterLogger("Modules.ReagentOptimization.UI")
...
function CraftSim.REAGENT_OPTIMIZATION.UI:UpdateReagentDisplay(recipeData)
    ...
    if recipeData.supportsQualities then
        ...
        if recipeData:HasSimplifiedQualityResult() then
            initialQualityIconLabel = GUTIL:GetQualityIconStringSimplified(initialValue, qualityIconSize, qualityIconSize,
                0, -2)
        else
