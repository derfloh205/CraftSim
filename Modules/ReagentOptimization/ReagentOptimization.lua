...
function CraftSim.REAGENT_OPTIMIZATION:OptimizeReagentAllocationOOP(recipeData, optimizeInspiration)
    ...
    for index = 0, #requiredReagents - 1, 1 do
        ...
        -- fill crumbs
        CraftSim.REAGENT_OPTIMIZATION:CreateCrumbsOOP(ksItem)
        ksItems[index] = ksItem
    end
    ...
    local expectedQualityWithoutReagents = CraftSim.AVERAGEPROFIT:GetExpectedQualityBySkillOOP(recipeData, skillWithoutReagentIncrease)
