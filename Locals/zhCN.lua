...
function CraftSim.LOCAL_CN:GetData()
    ...
    return {
        ...
        [CraftSim.CONST.TEXT.CRAFT_QUEUE_ADD_WORK_ORDERS_BUTTON_LABEL] = "排队添加客户订单",
        ...
        [CraftSim.CONST.TEXT.CRAFT_QUEUE_ADD_WORK_ORDERS_ONLY_PROFITABLE_TOOLTIP] = "只排队预期利润为正的客户订单",
