...
function CraftSim.LOCAL_CN:GetData()
    ...
    return {
        ...
        [CraftSim.CONST.TEXT.CRAFT_LOG_STATISTICS_1] = "制造：",
        ...
        [CraftSim.CONST.TEXT.CRAFT_LOG_STATISTICS_TRACKER_TAB_MULTICRAFT] = "产能",
        [CraftSim.CONST.TEXT.CRAFT_LOG_STATISTICS_TRACKER_TAB_RESOURCEFULNESS] = "充裕",
        [CraftSim.CONST.TEXT.CRAFT_LOG_STATISTICS_TRACKER_TAB_YIELD_DDISTRIBUTION] = "产量分布",
