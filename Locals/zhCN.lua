...
function CraftSim.LOCAL_CN:GetData()
    ...
    return {
        ...
        STAT_SKILL = "技能",
        STAT_MULTICRAFT_BONUS = "产能额外物品",
        STAT_RESOURCEFULNESS_BONUS = "充裕额外物品",
        STAT_CRAFTINGSPEED_BONUS = "制造速度",
        STAT_INGENUITY_BONUS = "奇思节省专注",
        STAT_INGENUITY_LESS_CONCENTRATION = "更少的专注使用",
        ...
        SIMULATION_MODE_TITLE = "CraftSim 模拟模式",
        SIMULATION_MODE_TOOLTIP =
        "CraftSim 的模拟模式可以不受限制地尝试配方",
        SIMULATION_MODE_OPTIONAL = "可选 #",
        SIMULATION_MODE_FINISHING = "正在完成 #",
        SIMULATION_MODE_QUALITY_BUTTON_TOOLTIP = "所有材料使用最高品质",
        SIMULATION_MODE_CLEAR_BUTTON = "清除",
        SIMULATION_MODE_CONCENTRATION = " 专注",
        SIMULATION_MODE_CONCENTRATION_COST = "专注成本：",
        CONCENTRATION_ESTIMATED_TIME_UNTIL = "可制作于：%s",
        SIMULATION_MODE_QUALITY_METER_NEEDED = "需要：",
        SIMULATION_MODE_QUALITY_METER_MISSING = "还缺：",
        SIMULATION_MODE_QUALITY_METER_MAX = "最大值",

        -- Details Frame
        RECIPE_DIFFICULTY_LABEL = "配方难度：",
        MULTICRAFT_LABEL = "产能：",
        RESOURCEFULNESS_LABEL = "充裕：",
        RESOURCEFULNESS_BONUS_LABEL = "充裕节省加成：",
        ...
        POPUP_NO_PRICE_SOURCE_TITLE = "CraftSim 价格来源警告",
        POPUP_NO_PRICE_SOURCE_WARNING =
        "没有找到价格来源！\n\n至少需要安装下面其中一个价格来源插件，CraftSim 才能计算利润：\n\n\n",
        POPUP_NO_PRICE_SOURCE_WARNING_SUPPRESS = "不要再显示警告",
        POPUP_NO_PRICE_SOURCE_WARNING_ACCEPT = "好的",

        -- Reagents Frame
        REAGENT_OPTIMIZATION_TITLE = "CraftSim 材料优化",
        ...
        REAGENTS_NO_COMBINATION = "无法找到提高\n品质的组合",
        REAGENTS_ASSIGN = "分配",
        REAGENTS_MAXIMUM_QUALITY = "最高品质：",
        REAGENTS_AVERAGE_PROFIT_LABEL = "平均 Ø 利润：",
        ...
        REAGENTS_OPTIMIZE_INFO = "在数字上按Shift+鼠标左键将物品链接放入聊天中",
        ADVANCED_OPTIMIZATION_BUTTON = "进阶优化",
        REAGENTS_OPTIMIZE_TOOLTIP =
            "（编辑后重置）\n启用" ..
            f.gold("专注值") .. " 和 " .. f.bb("完成材料") .. "优化",

        -- Specialization Info Frame
        SPEC_INFO_TITLE = "CraftSim 专精信息",
        SPEC_INFO_SIMULATE_KNOWLEDGE_DISTRIBUTION = "模拟专业知识点分配",
        SPEC_INFO_NODE_TOOLTIP = "该节点为您提供该配方的下列属性：",
        SPEC_INFO_WORK_IN_PROGRESS = "无可用数据",

        -- Crafting Results Frame
        CRAFT_LOG_TITLE = "CraftSim 制造记录",
        CRAFT_LOG_ADV_TITLE = "CraftSim 详细制造记录",
        CRAFT_LOG_LOG = "制造记录",
        CRAFT_LOG_LOG_1 = "利润：",
        CRAFT_LOG_LOG_2 = "节省专注：",
        CRAFT_LOG_LOG_3 = "产能：",
        CRAFT_LOG_LOG_4 = "节省资源：",
        CRAFT_LOG_LOG_5 = "机率：",
        CRAFT_LOG_CRAFTED_ITEMS = "制造的物品",
        CRAFT_LOG_SESSION_PROFIT = "此次利润：",
        CRAFT_LOG_RESET_DATA = "重置数据",
        CRAFT_LOG_EXPORT_JSON = "导出 JSON",
        CRAFT_LOG_RECIPE_STATISTICS = "配方统计数据",
        CRAFT_LOG_NOTHING = "尚未制造任何东西！",
        CRAFT_LOG_CALCULATION_COMPARISON_NUM_CRAFTS_PREFIX = "制造：",
        CRAFT_LOG_STATISTICS_2 = "预期 Ø 利润：",
        CRAFT_LOG_STATISTICS_3 = "实际 Ø 利润：",
        CRAFT_LOG_STATISTICS_4 = "实际利润：",
        CRAFT_LOG_STATISTICS_5 = "过程 - 实际/期望：",
        CRAFT_LOG_STATISTICS_7 = "产能：",
        CRAFT_LOG_STATISTICS_8 = "- Ø 额外物品：",
        CRAFT_LOG_STATISTICS_9 = "充裕过程：",
        CRAFT_LOG_CALCULATION_COMPARISON_NUM_CRAFTS_PREFIX0 = "- Ø 节省成本：",
        CRAFT_LOG_CALCULATION_COMPARISON_NUM_CRAFTS_PREFIX1 = "利润：",
        CRAFT_LOG_SAVED_REAGENTS = "节省材料",
        CRAFT_LOG_DISABLE_CHECKBOX = f.r("禁用") .. "制造记录",
        CRAFT_LOG_DISABLE_CHECKBOX_TOOLTIP =
            "启用此功能会停止在制作过程中记录任何物品，并可能" ..
            f.g("提高性能"),
        ...
        -- Stats Weight Frame
        STAT_WEIGHTS_TITLE = "CraftSim 平均利润",
        EXPLANATIONS_TITLE = "CraftSim 平均利润说明",
        STAT_WEIGHTS_SHOW_EXPLANATION_BUTTON = "显示说明",
        STAT_WEIGHTS_HIDE_EXPLANATION_BUTTON = "隐藏说明",
        STAT_WEIGHTS_SHOW_STATISTICS_BUTTON = "显示统计数据",
        STAT_WEIGHTS_HIDE_STATISTICS_BUTTON = "隐藏统计数据",
        STAT_WEIGHTS_PROFIT_CRAFT = "Ø 利润/制造：",
        ...
        COST_OPTIMIZATION_SUB_RECIPE_OPTIONS_TAB = "子配方选项",
        COST_OPTIMIZATION_SUB_RECIPE_OPTIMIZATION = "子配方优化" .. f.bb("(实验性)"),
        ...
        COST_OPTIMIZATION_SUB_RECIPE_INCLUDE_COOLDOWN_RECIPES = "包括冷却中的配方",
        ...
        STATISTICS_CHANCE_OF = "制造后",
        STATISTICS_PROFIT = "利润",
        STATISTICS_AFTER = " 的机率",
        STATISTICS_CRAFTS = "制造：",
        STATISTICS_QUALITY_HEADER = "品质",
        STATISTICS_CHANCE_HEADER = "机率",
        STATISTICS_EXPECTED_CRAFTS_HEADER = "Ø 预期制造",
        STATISTICS_MULTICRAFT_HEADER = "产能",
        STATISTICS_RESOURCEFULNESS_HEADER = "充裕",
        STATISTICS_HSV_NEXT = "HSV提升",
        STATISTICS_HSV_SKIP = "HSV跳过",
        STATISTICS_EXPECTED_PROFIT_HEADER = "预期利润",
        PROBABILITY_TABLE_TITLE = "配方概率表",
        STATISTICS_EXPECTED_COSTS_HEADER = "每件物品的 Ø 预期成本",
        STATISTICS_EXPECTED_COSTS_WITH_RETURN_HEADER = "Ø 销售回报",
        STATISTICS_PROBABILITY_TABLE_TAB = "概率表",
        STATISTICS_CONCENTRATION_TAB = "专注",
        STATISTICS_CONCENTRATION_CURVE_GRAPH = "专注成本曲线",
        ...
        -- Price Details Frame
        COST_OVERVIEW_TITLE = "CraftSim 价格明细",
        ...
        PRICE_OVERRIDE_TITLE = "CraftSim 重订价格",
        PRICE_OVERRIDE_HINT = "（您现在可以直接在" .. f.bb("成本明细模块") .. "重订价格了）",
        PRICE_OVERRIDE_REQUIRED_REAGENTS = "必要材料",
        PRICE_OVERRIDE_OPTIONAL_REAGENTS = "可选材料",
        PRICE_OVERRIDE_FINISHING_REAGENTS = "完成材料",
        PRICE_OVERRIDE_RESULT_ITEMS = "产出物品",
        PRICE_OVERRIDE_ACTIVE_OVERRIDES = "启用的重订价格",
        ...
        -- Recipe Scan Frame
        RECIPE_SCAN_TITLE = "CraftSim 配方扫描",
        ...
        RECIPE_SCAN_INCLUDE_NOT_LEARNED = "包含尚未学会",
        ...
        RECIPE_SCAN_INCLUDE_GEAR_TOOLTIP = "在配方扫描中包含所有种类的装备配方",
        ...
        RECIPE_SCAN_LEARNED_HEADER = "已学会",
        RECIPE_SCAN_RESULT_HEADER = "成品",
        RECIPE_SCAN_AVERAGE_PROFIT_HEADER = "Ø 利润",
        RECIPE_SCAN_CONCENTRATION_VALUE_HEADER = "专注值",
        RECIPE_SCAN_CONCENTRATION_COST_HEADER = "专注成本",
        RECIPE_SCAN_TOP_GEAR_HEADER = "最佳装备",
        RECIPE_SCAN_INV_AH_HEADER = "库存/拍卖",
        RECIPE_SCAN_SORT_BY_MARGIN = "按利润百分比排序",
        RECIPE_SCAN_SORT_BY_MARGIN_TOOLTIP =
        "根据和制造花费相关的利润排序利润清单。\n(需要重新扫描)",
        RECIPE_SCAN_USE_INSIGHT_CHECKBOX = "使用" .. f.bb("洞悉") .. " (如果可以的话)",
        RECIPE_SCAN_USE_INSIGHT_CHECKBOX_TOOLTIP = "如果配方允许，使用" ..
            f.bb("卓然洞悉") .. "或\n" .. f.bb("次级卓然洞悉") .. "作为可选的材料。",
        RECIPE_SCAN_ONLY_FAVORITES_CHECKBOX = "只有最爱",
        RECIPE_SCAN_ONLY_FAVORITES_CHECKBOX_TOOLTIP = "只扫描最爱的配方",
        RECIPE_SCAN_EQUIPPED = "已装备",
        RECIPE_SCAN_MODE_OPTIMIZE = "优化",
        RECIPE_SCAN_SORT_MODE_PROFIT = "利润",
        RECIPE_SCAN_SORT_MODE_RELATIVE_PROFIT = "相关的利润",
        RECIPE_SCAN_SORT_MODE_CONCENTRATION_VALUE = "专注值",
        RECIPE_SCAN_SORT_MODE_CONCENTRATION_COST = "专注成本",
        ...
        RECIPE_SCAN_ONLY_FAVORITES = f.r("仅") .. f.bb("最爱配方"),
        RECIPE_SCAN_INCLUDE_SOULBOUND_ITEMS = "包含" .. f.e("灵魂绑定") .. "物品",
        RECIPE_SCAN_INCLUDE_UNLEARNED_RECIPES = "包含" .. f.r("尚未学会的") .. "配方",
        ...
        RECIPE_SCAN_OPTIMIZE_PROFESSION_GEAR = "优化" .. f.bb("专业工具"),
        RECIPE_SCAN_OPTIMIZE_CONCENTRATION = "优化" .. f.gold("专注"),
        RECIPE_SCAN_OPTIMIZE_FINISHING_REAGENTS = "优化" .. f.bb("完成材料"),
        ...
        RECIPE_SCAN_SORT_ASCENDING = "递增",
        RECIPE_SCAN_REMOVE_FAVORITE = f.r("移除") .. "最爱",
        RECIPE_SCAN_ADD_FAVORITE = f.g("添加") .. "最爱",
        RECIPE_SCAN_FAVORITES_CRAFTER_ONLY = f.r("最爱只能在制作台上更改"),
        RECIPE_SCAN_QUEUE_HINT = "点击" ..
            CreateAtlasMarkup("NPE_LeftClick", 20, 20, 2) .. " + shift 将选定的配方加入" ..
            f.bb("制造队列"),
        RECIPE_SCAN_REMOVE_CACHED_DATA = f.r("移除"),
        RECIPE_SCAN_REMOVE_CACHED_DATA_TOOLTIP = f.r("移除") ..
            "与此角色-职业组合相关的所有缓存数据",
        RECIPE_SCAN_USE_TSM_RESTOCK = "使用" .. f.bb("TSM") .. "补货数量表达式",
        RECIPE_SCAN_TSM_SALE_RATE_THRESHOLD = f.bb("TSM") .. "成交率阈值：",
        RECIPE_SCAN_AUTOSELECT_OPEN_PROFESSION = "自动选择打开专业",

        -- Recipe Top Gear
        TOP_GEAR_TITLE = "CraftSim 最佳装备",
        ...
        TOP_GEAR_SIMULATE_EQUIPPED = "已穿上最佳装备",
        TOP_GEAR_SIMULATE_PROFIT_DIFFERENCE = "Ø 利润差\n",
        TOP_GEAR_SIMULATE_NEW_MUTLICRAFT = "新的产能\n",
        TOP_GEAR_SIMULATE_NEW_CRAFTING_SPEED = "新的制造速度\n",
        TOP_GEAR_SIMULATE_NEW_RESOURCEFULNESS = "新的充裕\n",
        TOP_GEAR_SIMULATE_NEW_SKILL = "新的技能\n",
        TOP_GEAR_SIMULATE_UNHANDLED = "未处理的模拟模式",

        TOP_GEAR_SIM_MODES_PROFIT = "最佳利润",
        TOP_GEAR_SIM_MODES_SKILL = "最佳技能",
        TOP_GEAR_SIM_MODES_MULTICRAFT = "最佳产能",
        TOP_GEAR_SIM_MODES_RESOURCEFULNESS = "最佳充裕",
        TOP_GEAR_SIM_MODES_CRAFTING_SPEED = "最佳制造速度",

        -- Options
        OPTIONS_TITLE = "CraftSim 选项",
        OPTIONS_GENERAL_TAB = "一般",
        OPTIONS_GENERAL_PRICE_SOURCE = "价格来源",
        OPTIONS_GENERAL_CURRENT_PRICE_SOURCE = "当前价格来源：",
        OPTIONS_GENERAL_NO_PRICE_SOURCE = "没有加载支持的价格来源插件！",
        ...
        OPTIONS_PERFORMANCE_RAM_CRAFTS = "个制造",
        ...
        OPTIONS_TSM_RESET = "恢复成默认值",
        OPTIONS_TSM_INVALID_EXPRESSION = "语法不正确",
        OPTIONS_TSM_VALID_EXPRESSION = "语法正确",
        OPTIONS_TSM_DEPOSIT_ENABLED_LABEL = "启用预期保证金成本",
        OPTIONS_TSM_DEPOSIT_ENABLED_TOOLTIP = "从利润计算中扣除预期的拍卖行保证金成本。\n使用TSM价格数据来估算您在上架时需要支付的保证金。",
        OPTIONS_TSM_DEPOSIT_EXPRESSION_LABEL = "TSM保证金表达式",
        OPTIONS_TSM_SMART_RESTOCK_ENABLED_LABEL = "智能补货（减去库存）",
        OPTIONS_TSM_SMART_RESTOCK_ENABLED_TOOLTIP = "当发送配方到制作队列时，从补货数量中减去您已拥有的物品。\n（背包，银行，小号角色，战团银行）",
        ...
        OPTIONS_MODULES_CUSTOMER_HISTORY_SIZE = "每个客户的历史消息上限",
        OPTIONS_MODULES_CUSTOMER_HISTORY_MAX_ENTRIES_PER_CLIENT = "每个客户的最大历史记录条数",
        ...
        "默认：0.3\n\n来自 beta 以及早期搜集不同玩家数据的制作数据显示。\n平均节省的物品数量为所需数量的 30%。\n如果想要的话可以修改此处的值。",
        OPTIONS_GENERAL_SHOW_NEWS_CHECKBOX = "显示" .. f.bb("更新信息"),
        ...
        OPTIONS_GENERAL_HIDE_MINIMAP_BUTTON_TOOLTIP = "启用以隐藏 " ..
            f.l("CraftSim") .. " 小地图按钮",
        OPTIONS_GENERAL_COIN_MONEY_FORMAT_CHECKBOX = "使用硬币图标：",
        OPTIONS_GENERAL_COIN_MONEY_FORMAT_TOOLTIP = "使用硬币图标显示货币",
        ...
        CONTROL_PANEL_MODULES_PRICE_OVERRIDES_LABEL = "重订价格",
        ...
        CONTROL_PANEL_MODULES_CRAFT_LOG_LABEL = "制造记录",
        CONTROL_PANEL_MODULES_CRAFT_LOG_TOOLTIP =
        "显示制造的日志和统计数据！",
        CONTROL_PANEL_MODULES_COST_OPTIMIZATION_LABEL = "成本明细",
        CONTROL_PANEL_MODULES_COST_OPTIMIZATION_TOOLTIP =
        "显示制造成本详细信息的模块",
        CONTROL_PANEL_MODULES_STATISTICS_LABEL = "统计",
        ...
        "根据多种不同的选项扫描你的配方列表",
        CONTROL_PANEL_MODULES_CUSTOMER_HISTORY_LABEL = "客户记录",
        CONTROL_PANEL_MODULES_CUSTOMER_HISTORY_TOOLTIP =
        "提供与客户对谈的历史记录、制作过的物品和佣金的模块",
        CONTROL_PANEL_MODULES_CRAFT_BUFFS_LABEL = "制造增益效果",
        CONTROL_PANEL_MODULES_CRAFT_BUFFS_TOOLTIP =
        "显示你激活和缺失的制造增益效果的模块",
        CONTROL_PANEL_MODULES_EXPLANATIONS_LABEL = "解释",
        ...
        CONTROL_PANEL_EASYCRAFT_EXPORT_NO_RECIPE_FOUND = "没有适用于地心之战资料片的导出配方",
        ...
        -- Customer History
        CUSTOMER_HISTORY_TITLE = "CraftSim 客户记录",
        CUSTOMER_HISTORY_DROPDOWN_LABEL = "选择客户",
        CUSTOMER_HISTORY_TOTAL_TIP = "小费总计：",
        CUSTOMER_HISTORY_FROM = "来自",
        CUSTOMER_HISTORY_TO = "给",
        CUSTOMER_HISTORY_FOR = "给",
        CUSTOMER_HISTORY_CRAFT_FORMAT = "制造 %s 给 %s",
        CUSTOMER_HISTORY_DELETE_BUTTON = "移除客户",
        CUSTOMER_HISTORY_WHISPER_BUTTON_LABEL = "密语..",
        CUSTOMER_HISTORY_PURGE_NO_TIP_LABEL = "移除 0 小费客户",
        CUSTOMER_HISTORY_PURGE_ZERO_TIPS_CONFIRMATION_POPUP = "是否确定要删除小费总计为 0 的所有客户数据？",
        CUSTOMER_HISTORY_DELETE_CUSTOMER_CONFIRMATION_POPUP = "是否确定要删除 %s 的所有数据？",
        CUSTOMER_HISTORY_PURGE_DAYS_INPUT_LABEL = "天后自动移除",
        CUSTOMER_HISTORY_PURGE_DAYS_INPUT_TOOLTIP =
        "CraftSim 会在每次登录后，自动删除上次删除后 X 天的所有低于设定小费的客户。\n设为 0 时，CraftSim 将完全不会自动删除。",
        CUSTOMER_HISTORY_CUSTOMER_HEADER = "客户",
        CUSTOMER_HISTORY_TOTAL_TIP_HEADER = "小费总计",
        CUSTOMER_HISTORY_CRAFT_HISTORY_DATE_HEADER = "日期",
        CUSTOMER_HISTORY_CRAFT_HISTORY_RESULT_HEADER = "成品",
        CUSTOMER_HISTORY_CRAFT_HISTORY_TIP_HEADER = "小费",
        CUSTOMER_HISTORY_CRAFT_HISTORY_CUSTOMER_REAGENTS_HEADER = "客户材料",
        CUSTOMER_HISTORY_CRAFT_HISTORY_CUSTOMER_NOTE_HEADER = "备注",
        CUSTOMER_HISTORY_CHAT_MESSAGE_TIMESTAMP = "时间",
        CUSTOMER_HISTORY_CHAT_MESSAGE_SENDER = "发送者",
        CUSTOMER_HISTORY_CHAT_MESSAGE_MESSAGE = "消息",
        CUSTOMER_HISTORY_CHAT_MESSAGE_YOU = "[你]: ",
        CUSTOMER_HISTORY_CRAFT_LIST_TIMESTAMP = "时间",
        CUSTOMER_HISTORY_CRAFT_LIST_RESULTLINK = "成品链接",
        CUSTOMER_HISTORY_CRAFT_LIST_TIP = "小费",
        CUSTOMER_HISTORY_CRAFT_LIST_REAGENTS = "材料",
        CUSTOMER_HISTORY_CRAFT_LIST_SOMENOTE = "注释",
        CUSTOMER_HISTORY_TOTAL_AMOUNT = "总量",
        ...
        CUSTOMER_HISTORY_CATEGORY_REMOVE_ALL_CUSTOMER_DATA = f.r("确定移除所有客户数据吗？"),
        CUSTOMER_HISTORY_CATEGORY_DELETE_CUSTOMER = "删除客户",

        -- Craft Queue
        CRAFT_QUEUE_TITLE = "CraftSim 制造队列",
        CRAFT_QUEUE_CRAFT_AMOUNT_LEFT_HEADER = "排队中",
        CRAFT_QUEUE_CRAFT_PROFESSION_GEAR_HEADER = "专业工具",
        CRAFT_QUEUE_CRAFTING_COSTS_HEADER = "制造成本",
        CRAFT_QUEUE_CRAFT_BUTTON_ROW_LABEL = "制造",
        CRAFT_QUEUE_CRAFT_BUTTON_ROW_LABEL_WRONG_GEAR = "工具错误",
        CRAFT_QUEUE_CRAFT_BUTTON_ROW_LABEL_NO_REAGENTS = "没有材料",
        CRAFT_QUEUE_ADD_OPEN_RECIPE_BUTTON_LABEL = "排队添加开放材料",
        CRAFT_QUEUE_ADD_FIRST_CRAFTS_BUTTON_LABEL = "排队添加首次制造",
        CRAFT_QUEUE_ADD_WORK_ORDERS_BUTTON_LABEL = "排队添加制造订单",
        ...
        CRAFT_QUEUE_ADD_WORK_ORDERS_ONLY_PROFITABLE_CHECKBOX = "仅限有利润",
        CRAFT_QUEUE_ADD_WORK_ORDERS_ONLY_PROFITABLE_TOOLTIP = "只排队预期利润为正的制造订单",
        CRAFT_QUEUE_WORK_ORDER_TYPE_BUTTON = "制造订单类型",
        CRAFT_QUEUE_PATRON_ORDERS_BUTTON = "客人订单",
        CRAFT_QUEUE_GUILD_ORDERS_BUTTON = "工会订单",
        CRAFT_QUEUE_PERSONAL_ORDERS_BUTTON = "个人订单",
        CRAFT_QUEUE_GUILD_ORDERS_ALTS_ONLY_CHECKBOX = f.r("仅") .. "小号角色",
        CRAFT_QUEUE_PATRON_ORDERS_FORCE_CONCENTRATION_CHECKBOX = f.r("强制使用") .. f.gold("专注"),
        CRAFT_QUEUE_PATRON_ORDERS_FORCE_CONCENTRATION_TOOLTIP = "尽可能强制为所有客人订单使用专注",
        ...
        CRAFT_QUEUE_PATRON_ORDERS_ACUITY_TOOLTIP = "包含有匠人之敏/匠人之魄作为奖励的订单",
        CRAFT_QUEUE_PATRON_ORDERS_POWER_RUNE_CHECKBOX = "包含" .. f.bb("强化符文") .. "奖励",
        CRAFT_QUEUE_PATRON_ORDERS_POWER_RUNE_TOOLTIP = "包含有强化符文作为奖励的订单",
        CRAFT_QUEUE_PATRON_ORDERS_KNOWLEDGE_POINTS_CHECKBOX = "包含" .. f.bb("知识点") .. "奖励",
        CRAFT_QUEUE_PATRON_ORDERS_KNOWLEDGE_POINTS_TOOLTIP = "包含有知识点作为奖励的订单",
        CRAFT_QUEUE_PATRON_ORDERS_KNOWLEDGE_POINTS_MAX_COST = f.bb("知识点") .. "最大成本：",
        CRAFT_QUEUE_PATRON_ORDERS_KNOWLEDGE_POINTS_MAX_COST_TOOLTIP = "每1知识点的最大允许金币成本\n\n格式：",
        CRAFT_QUEUE_PATRON_ORDERS_MAX_COST = f.bb("客人订单") .. "最大成本：",
        CRAFT_QUEUE_PATRON_ORDERS_MAX_COST_TOOLTIP = "每个客人订单的最大允许金币成本\n\n格式：",
        CRAFT_QUEUE_PATRON_ORDERS_REAGENT_BAG_VALUE = f.bb("材料包") .. "价值：",
        CRAFT_QUEUE_PATRON_ORDERS_REAGENT_BAG_VALUE_TOOLTIP = "将添加到您利润中的" .. f.bb("材料包奖励") .. "的价值。\n\n格式：",
        CRAFT_QUEUE_CLEAR_ALL_BUTTON_LABEL = "全部清除",
        CRAFT_QUEUE_RESTOCK_FAVORITES_BUTTON_LABEL = "排队添加最爱配方",
        CRAFT_QUEUE_RESTOCK_FAVORITES_SMART_CONCENTRATION_QUEUING = f.bb("智能") .. f.gold("专注") .. f.bb("队列"),
        ...
        CRAFT_QUEUE_RESTOCK_OPTIONS_SALE_RATE_INPUT_LABEL = "销售率阈值：",
...
是否大于或等于设置的销售率阈值。
        ...
        CRAFT_QUEUE_RESTOCK_OPTIONS_RESTOCK_TOOLTIP = "这是该配方正在排队的" ..
            f.bb("制作数量") ..
            "。\n\n您在背包与银行中拥有该星级数量的物品将从补货数量中扣除",
        CRAFT_QUEUE_RESTOCK_OPTIONS_ENABLE_RECIPE_LABEL = "启用：",
        CRAFT_QUEUE_RESTOCK_OPTIONS_GENERAL_OPTIONS_LABEL = "一般选项 (所有配方)",
        CRAFT_QUEUE_RESTOCK_OPTIONS_ENABLE_RECIPE_TOOLTIP =
        "如果此选项为关闭，将根据上述的一般选项进补货",
        CRAFT_QUEUE_TOTAL_PROFIT_LABEL = "总计 Ø 利润：",
        CRAFT_QUEUE_TOTAL_CRAFTING_COSTS_LABEL = "总计制造成本：",
        ...
        CRAFT_QUEUE_EDIT_RECIPE_OPTIONAL_REAGENTS_LABEL = "可选材料",
        CRAFT_QUEUE_EDIT_RECIPE_FINISHING_REAGENTS_LABEL = "完成材料",
        CRAFT_QUEUE_EDIT_RECIPE_SPARK_LABEL = "必须",
        CRAFT_QUEUE_EDIT_RECIPE_PROFESSION_GEAR_LABEL = "专业工具",
        ...
        CRAFT_QUEUE_EDIT_RECIPE_RESULTS_LABEL = "成品",
        CRAFT_QUEUE_EDIT_RECIPE_CONCENTRATION_CHECKBOX = " 专注",
        CRAFT_QUEUE_AUCTIONATOR_SHOPPING_LIST_PER_CHARACTER_CHECKBOX = "每个角色",
        CRAFT_QUEUE_AUCTIONATOR_SHOPPING_LIST_PER_CHARACTER_CHECKBOX_TOOLTIP = "单独为每个工匠角色创建一个 " ..
            f.bb("Auctionator 购物清单") .. " 。\n而不是为所有角色创建一个购物清单",
        CRAFT_QUEUE_AUCTIONATOR_SHOPPING_LIST_TARGET_MODE_CHECKBOX = "仅目标模式",
        CRAFT_QUEUE_AUCTIONATOR_SHOPPING_LIST_TARGET_MODE_CHECKBOX_TOOLTIP = "仅为目标模式配方创建一个 " ..
            f.bb("Auctionator 购物清单") .. " 。",
        CRAFT_QUEUE_UNSAVED_CHANGES_TOOLTIP = f.white("未保存的队列数量。\n按回车保存"),
        CRAFT_QUEUE_STATUSBAR_LEARNED = f.white("配方已学会"),
        CRAFT_QUEUE_STATUSBAR_COOLDOWN = f.white("未处于冷却状态"),
        CRAFT_QUEUE_STATUSBAR_REAGENTS = f.white("可用材料"),
        CRAFT_QUEUE_STATUSBAR_GEAR = f.white("已装备专业装备"),
        CRAFT_QUEUE_STATUSBAR_CRAFTER = f.white("正确的工匠角色"),
        CRAFT_QUEUE_STATUSBAR_PROFESSION = f.white("专业启用"),
        CRAFT_QUEUE_BUTTON_EDIT = "编辑",
        CRAFT_QUEUE_BUTTON_CRAFT = "制造",
        CRAFT_QUEUE_BUTTON_CLAIM = "接单",
        CRAFT_QUEUE_BUTTON_CLAIMED = "已接单",
        CRAFT_QUEUE_BUTTON_NEXT = "下一个：",
        CRAFT_QUEUE_BUTTON_NOTHING_QUEUED = "无排队中",
        CRAFT_QUEUE_BUTTON_ORDER = "订购",
        ...
        CRAFT_BUFFS_TITLE = "CraftSim 制造增益效果",
        ...
        COOLDOWNS_TITLE = "CraftSim 冷却",
        CONTROL_PANEL_MODULES_COOLDOWNS_LABEL = "冷却",
        CONTROL_PANEL_MODULES_COOLDOWNS_TOOLTIP = "总览你账号的 " ..
            f.bb("专业冷却"),
        ...
        CONCENTRATION_TRACKER_TITLE = "CraftSim 专注",
        CONCENTRATION_TRACKER_LABEL_CRAFTER = "工匠",
        CONCENTRATION_TRACKER_LABEL_CURRENT = "当前",
        CONCENTRATION_TRACKER_LABEL_MAX = "最大",
        CONCENTRATION_TRACKER_MAX = f.g("最大"),
        CONCENTRATION_TRACKER_MAX_VALUE = "最大值：",
        CONCENTRATION_TRACKER_FULL = f.g("专注值满"),
        ...
        CONCENTRATION_TRACKER_LIST_TAB_REMOVE_AND_BLACKLIST = "移除并加入黑名单",
