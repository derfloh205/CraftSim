...
function CraftSim.LOCAL_CN:GetData()
    ...
    local shatter_post_login_tooltip = "\n\n" ..
        f.white("登录后施放一次粉碎，使增益效果与CraftSim同步。")
    return {
        -- REQUIRED:
        STAT_MULTICRAFT = "产能",
        ...
        STAT_RESOURCEFULNESS_BONUS = "充裕额外资源",
        STAT_CRAFTINGSPEED_BONUS = "制作速度",
        STAT_INGENUITY_BONUS = "奇思额外专注",
        ...
        EXPLANATIONS_PROFIT_CALCULATION_EXPLANATION = f.r("警告：") .. "前方硬核数学！\n\n" ..
            ...
            f.bb("情况B的概率为70%") ..
            "且利润为" ..
            CraftSim.GUTIL:FormatMoney(300 * 10000, true, 0, true, false, false) .. "那么期望利润为" ..
            f.bb("\nE(X) = -100*0.3 + 300*0.7") ..
            "等于" .. CraftSim.GUTIL:FormatMoney((-100 * 0.3 + 300 * 0.7) * 10000, true, 0, true, false, false) .. "\n" ..
            "可以在" .. f.bb("统计信息") .. "窗口中查看当前配方的所有可能情况！"
        ,
        ...
        CRAFT_LOG_DISABLE_CHECKBOX_TOOLTIP = "启用后停止记录制造信息，可能会" ..
            f.g("提高性能"),
        ...
        RECIPE_SCAN_CONCENTRATION_VALUE_HEADER = "专注价值",
        ...
        RECIPE_SCAN_SORT_MODE_CONCENTRATION_VALUE = "专注价值",
        ...
        "启用后，CraftSim会在每隔指定次数的制造后清除内存中未使用的数据，防止内存堆积。\n内存堆积也有可能是其他插件引起，而非CraftSim。\n清理操作会影响整个魔兽的内存占用。",
        ...
        "材料组合建议会尝试达到临界点+1，而不是刚好满足所需的技能点数",
        ...
        "启用后，物品提示中会列出CraftSim记录中已学习此配方的角色（以及任何拥有此物品最近制造数据的角色）。",
        ...
        CONTROL_PANEL_PATCH_NOTES = "更新日志",
        ...
        "当距离上次移除超过X天后，登录时CraftSim会自动移除所有低于设定佣金阈值的客户。\n设置为0则CraftSim永远不会自动移除。",
        ...
        CUSTOMER_HISTORY_CATEGORY_REMOVE_ALL_CUSTOMER_DATA = f.r("确定要删除所有客户数据吗？"),
        ...
        CRAFT_QUEUE_PATRON_ORDERS_MAX_DURATION_HOURS = f.bb("客人订单") .. "最长时间（小时）：",
        CRAFT_QUEUE_PATRON_ORDERS_MAX_DURATION_HOURS_TOOLTIP =
            "仅添加剩余时间在指定时间内的客人订单到队列。\n\n设置为" ..
            f.bb("0") .. "禁用",
        CRAFT_QUEUE_PATRON_ORDERS_MAX_DURATION_RESET = "重置",
        ...
        CRAFT_QUEUE_PATRON_ORDERS_SKIP_OWNED_MATERIAL_COSTS_CHECKBOX = "忽略" .. f.g("已有") .. "材料成本",
        CRAFT_QUEUE_PATRON_ORDERS_SKIP_OWNED_MATERIAL_COSTS_TOOLTIP = "启用后，计算" ..
            f.bb("客人订单") .. "的利润、最大成本和专业知识成本时，会将" ..
            f.bb("背包、银行和战团银行") .. "中已有的材料视为0成本。\n\n" ..
            "材料会在队列的所有客人订单中追踪，避免重复计算同一材料。",
        ...
        CRAFT_QUEUE_FLASH_TASKBAR_OPTION_TOOLTIP =
            ...
            "中的配方制造完成时，" .. f.l(" CraftSim") .. "会闪烁任务栏中魔兽世界图标",
...
是否大于或等于设置的售出率阈值。
        ...
        CRAFT_QUEUE_RESTOCK_OPTIONS_RESTOCK_TOOLTIP = "这是此配方添加到队列的" ..
            f.bb("待制造次数") ..
            "。\n\n补货数量会减去背包和银行中已有的对应品质材料",
        ...
        CRAFT_QUEUE_STATUS_SHATTER_AFTER_LOGIN = "登录后需要重新粉碎",
        ...
        CRAFT_QUEUE_MENU_MIDNIGHT_SHATTER_FORCE_BUFF = f.gold("强制") ..
            f.bb("碎裂精华") .. "（至暗之夜附魔）",
        CRAFT_QUEUE_MENU_MIDNIGHT_SHATTER_FORCE_BUFF_TOOLTIP = "启用后，CraftSim会要求在制造附魔配方前激活" ..
            f.bb("碎裂精华") .. "增益效果。\n\n" ..
            "粉碎按钮会显示在按钮序列中，优化配方时会假设已激活此增益。\n\n" ..
            "禁用后，完全跳过粉碎步骤，优化时不考虑此增益。",
        CRAFT_QUEUE_MENU_TWW_ENCHANT_SHATTER_FORCE_BUFF = f.gold("强制") ..
            f.bb("碎裂精华") .. "（" ..
            CraftSim.GUTIL:ColorizeText("地心之战", CraftSim.GUTIL.COLORS.LEGENDARY) .. "附魔）",
        CRAFT_QUEUE_MENU_TWW_ENCHANT_SHATTER_FORCE_BUFF_TOOLTIP = "启用后，CraftSim会要求在制造地心之战附魔配方前激活" ..
            f.bb("碎裂精华") .. "增益效果。\n\n" ..
            "粉碎按钮会显示在按钮序列中，优化配方时会假设已激活此增益。\n\n" ..
            "禁用后，完全跳过粉碎步骤，优化时不考虑此增益。",
        CRAFT_QUEUE_MENU_EVERBURNING_IGNITION_FORCE_BUFF = f.gold("强制") ..
            f.bb("永燃点火装置") .. "（地心之战锻造）",
        CRAFT_QUEUE_MENU_EVERBURNING_IGNITION_FORCE_BUFF_TOOLTIP = "启用后，CraftSim会在优化地心之战锻造配方时始终假设已激活" ..
            f.bb("永燃点火装置") ..
            "增益效果。\n\n" ..
            "不会在队列中添加类似粉碎的前置条件。",
        ...
        CRAFT_LISTS_OPTIONS_OPTIMIZE_CONCENTRATION_TOOLTIP =
            "提升材料品质使每点专注的利润最大化",
        CRAFT_LISTS_OPTIONS_CONCENTRATION = f.gold("专注"),
        CRAFT_LISTS_OPTIONS_CONCENTRATION_DISABLED = "禁用",
        CRAFT_LISTS_OPTIONS_CONCENTRATION_DISABLED_TOOLTIP =
            "此列表在扫描或添加队列时不使用专注",
        CRAFT_LISTS_OPTIONS_CONCENTRATION_ENABLED = "启用",
        CRAFT_LISTS_OPTIONS_CONCENTRATION_ENABLED_TOOLTIP =
            "使用专注进行优化；添加完整列表到队列，忽略当前专注",
        CRAFT_LISTS_OPTIONS_CONCENTRATION_SINGLE = "最高配方",
        CRAFT_LISTS_OPTIONS_CONCENTRATION_SINGLE_TOOLTIP =
            "每个专业仅添加专注价值最高的配方到队列，受剩余专注限制",
        CRAFT_LISTS_OPTIONS_CONCENTRATION_MULTI = "多个配方",
        CRAFT_LISTS_OPTIONS_CONCENTRATION_MULTI_TOOLTIP =
            "按专注价值从高到低添加多个配方到队列，直到剩余专注耗尽",
        ...
        CRAFT_LISTS_SKIP_OWNED_MATERIAL_COSTS_LABEL = "忽略" .. f.g("已有") .. "材料成本",
        CRAFT_LISTS_SKIP_OWNED_MATERIAL_COSTS_TOOLTIP = "启用后，计算" ..
            f.bb("仅限正利润") .. "以及利润相关的数据时，会将已有的材料视为0成本。\n\n" ..
            "使用制作者的" .. f.bb("背包、银行和战团银行") .. "。如果" ..
            f.bb("包含小号库存") .. "已启用，也会使用小号库存。\n\n" ..
            "材料会在队列的所有制造列表中共享，避免重复计算同一材料。",
        ...
        CRAFT_LISTS_RECIPE_SUPPORTED_QUALITIES = "可选品质",
        ...
        CONCENTRATION_TRACKER_FULL = f.g("专注已满"),
        ...
        CONCENTRATION_TRACKER_LIST_ROW_ACUITY = "匠人之敏：%s",
        ...
        WORK_ORDER_TRACKER_TITLE = "CraftSim客人订单",
        CONTROL_PANEL_MODULES_WORK_ORDER_TRACKER_LABEL = "客人订单",
        CONTROL_PANEL_MODULES_WORK_ORDER_TRACKER_TOOLTIP = "追踪小号缓存的" ..
            f.bb("客人订单") .. "，包含过期时间和可制作状态",
        WORK_ORDER_TRACKER_LIST_TAB_LABEL = "订单",
        WORK_ORDER_TRACKER_OPTIONS_TAB_LABEL = "选项",
        WORK_ORDER_TRACKER_REFRESH_BUTTON = "刷新",
        WORK_ORDER_TRACKER_COLUMN_CRAFTER = "制作者",
        WORK_ORDER_TRACKER_COLUMN_RECIPE = "配方",
        WORK_ORDER_TRACKER_COLUMN_TIME = "时间",
        WORK_ORDER_TRACKER_COLUMN_STATUS = "状态",
        WORK_ORDER_TRACKER_TIME_EXPIRED = f.grey("已过期"),
        WORK_ORDER_TRACKER_TIME_LT_6H = f.r("<6小时"),
        WORK_ORDER_TRACKER_TIME_6_12H = f.l("6-12小时"),
        WORK_ORDER_TRACKER_TIME_12_24H = f.bb("12-24小时"),
        WORK_ORDER_TRACKER_TIME_GT_24H = f.g(">24小时"),
        WORK_ORDER_TRACKER_CLAIMED = "已接单",
        WORK_ORDER_TRACKER_UNKNOWN_RECIPE = "未知配方",
        WORK_ORDER_TRACKER_LAST_SNAPSHOT_FMT = "%s前更新",
        WORK_ORDER_TRACKER_TOOLTIP_STATUS = "状态",
        WORK_ORDER_TRACKER_TOOLTIP_REQUIRED_QUALITY = "要求品质",
        WORK_ORDER_TRACKER_TOOLTIP_QUALITY = "预期品质",
        WORK_ORDER_TRACKER_TOOLTIP_REQUIRED_SHORT = "要求",
        WORK_ORDER_TRACKER_TOOLTIP_EXPECTED_SHORT = "预期",
        WORK_ORDER_TRACKER_TOOLTIP_EXPIRES = "过期时间：%s",
        WORK_ORDER_TRACKER_TOOLTIP_CLAIM_ENDS = "交单时间：%s",
        WORK_ORDER_TRACKER_OPTION_AUTO_SNAPSHOT = "打开专业订单时自动快照",
        WORK_ORDER_TRACKER_OPTION_USE_CONCENTRATION = "使用专注预估品质",
        WORK_ORDER_TRACKER_OPTION_SORT_MODE = "排序方式：",
        WORK_ORDER_TRACKER_STATUS_FILTER_TITLE = "按状态过滤",
        WORK_ORDER_TRACKER_STATUS_FILTER_TOOLTIP = "按可制作状态过滤订单",
        WORK_ORDER_TRACKER_SORT_MODE_TIME = "时间（紧急程度）",
        WORK_ORDER_TRACKER_SORT_MODE_CHARACTER = "制作者",
        WORK_ORDER_TRACKER_SORT_MODE_PROFESSION = "专业",
        WORK_ORDER_TRACKER_SORT_MODE_RECIPE = "配方",
        WORK_ORDER_TRACKER_CRAFTABILITY_READY = f.g("就绪"),
        WORK_ORDER_TRACKER_CRAFTABILITY_NEEDS_RECIPE = f.r("需要配方"),
        WORK_ORDER_TRACKER_CRAFTABILITY_NEEDS_QUALITY = f.r("需要专精/品质"),
        WORK_ORDER_TRACKER_CRAFTABILITY_NEEDS_REAGENTS = f.l("需要材料"),
        WORK_ORDER_TRACKER_CRAFTABILITY_ON_COOLDOWN = f.l("冷却中"),
        WORK_ORDER_TRACKER_CRAFTABILITY_IN_PROGRESS = f.bb("已接单"),
        WORK_ORDER_TRACKER_CRAFTABILITY_BLOCKED = f.r("已阻止"),
        WORK_ORDER_TRACKER_CRAFTABILITY_READY_TO_CRAFT = "可制造",
        WORK_ORDER_TRACKER_TOOLTIP_RECIPE_SOURCE = "配方来源",
        WORK_ORDER_TRACKER_TOOLTIP_SUGGESTED_SPEC = "建议专精",
        WORK_ORDER_TRACKER_HINT_OPEN_SPEC = "打开专精",
        WORK_ORDER_TRACKER_HINT_VIEW_RECIPE_SOURCE = "查看配方来源",
        WORK_ORDER_TRACKER_HINT_ADD_TO_SHOPPING_LIST = "添加配方到Auctionator购物清单",
        WORK_ORDER_TRACKER_HINT_UNAVAILABLE = "打开专业查看来源",
        RECIPE_ACQUISITION_ADDED_TO_SHOPPING_LIST = "已添加%s到Auctionator购物清单",
        RECIPE_ACQUISITION_FAILED_TO_ADD_TO_SHOPPING_LIST = "无法添加%s到Auctionator购物清单",
        RECIPE_ACQUISITION_SHOPPING_LIST_AUCTIONATOR_REQUIRED = "使用购物清单需要Auctionator",
        CONTROL_PANEL_MODULES_SHOPPING_LIST_LABEL = "购物清单",
        CONTROL_PANEL_MODULES_SHOPPING_LIST_TOOLTIP = "打开 " .. f.bb("购物清单") ..
            "查看制造队列所需购买的材料",
        ...
        PATCH_NOTES_TITLE = "CraftSim更新日志",
        ...
        DISENCHANT_INFO_TOOLTIP = f.bb("中键/右键") ..
            f.white(" .. 临时添加到黑名单\n") ..
            f.bb("Shift + 中键/右键") .. f.white(" .. 永久添加到黑名单"),
