...
function CraftSim.LOCAL_CN:GetData()
    ...
    return {
        ...
        [CraftSim.CONST.TEXT.CRAFT_LOG_RESULT_DETAILS_TAB] = "统计追踪",
        [CraftSim.CONST.TEXT.CRAFT_LOG_RESULT_DETAILS_TAB_DISTRIBUTION_LABEL] = "成品分布",
        [CraftSim.CONST.TEXT.CRAFT_LOG_RESULT_DETAILS_TAB_DISTRIBUTION_HELP] = "制造物品成品的相对分布。\n（忽略产能数量）",
        [CraftSim.CONST.TEXT.CRAFT_LOG_RESULT_DETAILS_TAB_MULTICRAFT] = "产能",
        [CraftSim.CONST.TEXT.CRAFT_LOG_RESULT_DETAILS_TAB_RESOURCEFULNESS] = "充裕",
        [CraftSim.CONST.TEXT.CRAFT_LOG_RESULT_DETAILS_TAB_YIELD_DDISTRIBUTION] = "产量分布",
