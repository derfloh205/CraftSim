...
function CraftSim.LOCAL_EN:GetData()
    ...
    return {
        ...
        [CraftSim.CONST.TEXT.OPTIONS_GENERAL_HIDE_MINIMAP_BUTTON_TOOLTIP] = "Enable to hide the " .. f.l("CraftSim") .. " Minimap Button",
        ...
        [CraftSim.CONST.TEXT.CONTROL_PANEL_MODULES_CRAFT_BUFFS_TOOLTIP] = "Module that shows you your active and missing Craft Buffs",
