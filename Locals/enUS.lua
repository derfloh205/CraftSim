...
function CraftSim.LOCAL_EN:GetData()
    ...
    return {
        ...
        CONTROL_PANEL_MODULES_KNOWLEDGE_POINT_VALUE_LABEL = "Knowledge Point Value",
        CONTROL_PANEL_MODULES_KNOWLEDGE_POINT_VALUE_TOOLTIP =
        "Shows the profit value for each unspent knowledge point, helping you decide where to invest next!",
