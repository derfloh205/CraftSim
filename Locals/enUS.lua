...
function CraftSim.LOCAL_EN:GetData()
    ...
    return {
        ...
        [CraftSim.CONST.TEXT.OPTIONS_TSM_DEPOSIT_ENABLED_LABEL] = "Enable Expected Deposit Cost",
        [CraftSim.CONST.TEXT.OPTIONS_TSM_DEPOSIT_ENABLED_TOOLTIP] = "Subtract the expected AH deposit cost from profit calculations.\nUses TSM price data to estimate the deposit you will pay when listing.",
        [CraftSim.CONST.TEXT.OPTIONS_TSM_DEPOSIT_EXPRESSION_LABEL] = "TSM Deposit Expression",
        [CraftSim.CONST.TEXT.OPTIONS_TSM_SMART_RESTOCK_ENABLED_LABEL] = "Smart Restock (subtract inventory)",
        [CraftSim.CONST.TEXT.OPTIONS_TSM_SMART_RESTOCK_ENABLED_TOOLTIP] = "When sending recipes to the Craft Queue, subtract items you already own\n(bags, bank, alts, warbank) from the restock amount.",
        [CraftSim.CONST.TEXT.OPTIONS_TSM_SMART_RESTOCK_INCLUDE_ALTS_LABEL] = "Include alt characters",
        [CraftSim.CONST.TEXT.OPTIONS_TSM_SMART_RESTOCK_INCLUDE_WARBANK_LABEL] = "Include warbank",
        ...
        [CraftSim.CONST.TEXT.CRAFT_QUEUE_ADD_WORK_ORDERS_ALLOW_CONCENTRATION_CHECKBOX] = "Allow " .. f.gold("Concentration"),
        ...
        [CraftSim.CONST.TEXT.CRAFT_QUEUE_WORK_ORDER_TYPE_BUTTON] = "Work Order Type",
        [CraftSim.CONST.TEXT.CRAFT_QUEUE_PATRON_ORDERS_BUTTON] = "Patron Orders",
        [CraftSim.CONST.TEXT.CRAFT_QUEUE_GUILD_ORDERS_BUTTON] = "Guild Orders",
        [CraftSim.CONST.TEXT.CRAFT_QUEUE_PERSONAL_ORDERS_BUTTON] = "Personal Orders",
        [CraftSim.CONST.TEXT.CRAFT_QUEUE_GUILD_ORDERS_ALTS_ONLY_CHECKBOX] = f.r("Only ") .. "Alt Characters",
        [CraftSim.CONST.TEXT.CRAFT_QUEUE_PATRON_ORDERS_FORCE_CONCENTRATION_CHECKBOX] = f.r("Force ") .. f.gold("Concentration"),
        [CraftSim.CONST.TEXT.CRAFT_QUEUE_PATRON_ORDERS_FORCE_CONCENTRATION_TOOLTIP] = "Force the use of concentration for all patron orders if possible",
        [CraftSim.CONST.TEXT.CRAFT_QUEUE_PATRON_ORDERS_SPARK_RECIPES_CHECKBOX] = "Include " .. f.e("Spark") .. " Recipes",
        [CraftSim.CONST.TEXT.CRAFT_QUEUE_PATRON_ORDERS_SPARK_RECIPES_TOOLTIP] = "Include Orders that use a Spark as Reagent",
        [CraftSim.CONST.TEXT.CRAFT_QUEUE_PATRON_ORDERS_ACUITY_CHECKBOX] = "Include " .. f.bb("Acuity/Moxie") .. " Rewards",
        [CraftSim.CONST.TEXT.CRAFT_QUEUE_PATRON_ORDERS_ACUITY_TOOLTIP] = "Include Orders with Acuity/Moxie Rewards",
        [CraftSim.CONST.TEXT.CRAFT_QUEUE_PATRON_ORDERS_POWER_RUNE_CHECKBOX] = "Include " .. f.bb("Augment Rune") .. " Rewards",
        ...
        [CraftSim.CONST.TEXT.CRAFT_QUEUE_SHATTER_MOTE_AUTOMATIC] = "Automatic (cheapest)",
        [CraftSim.CONST.TEXT.CRAFT_QUEUE_SHATTER_RIGHT_CLICK_HINT] = "\nRight-click to choose mote.",
