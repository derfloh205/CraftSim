...
function CraftSim.LOCAL_DE:GetData()
    ...
    return {
        ...
        [CraftSim.CONST.TEXT.OPTIONS_GENERAL_SHOW_NEWS_CHECKBOX_TOOLTIP] = "Zeige das " ..
            f.bb("News") .. " Fenster für neue " .. f.l("CraftSim") .. " Updates beim Einloggen",
        ...
        "Sortiere die Profitliste nach Profit relativ zu den Herstellungskosten.\n(Rezepte müssen erneut gescannt werden)",
        [CraftSim.CONST.TEXT.RECIPE_SCAN_USE_INSIGHT_CHECKBOX] = "Benutze " .. f.bb("Einsicht") .. " falls möglich",
        [CraftSim.CONST.TEXT.RECIPE_SCAN_USE_INSIGHT_CHECKBOX_TOOLTIP] = "Benutze " ..
            f.bb("Glorreiche Einsicht") ..
        ...
        [CraftSim.CONST.TEXT.CRAFT_RESULTS_DISABLE_CHECKBOX_TOOLTIP] =
            "Das Ausschalten der Herstellungsaufzeichnungen könnte die " ..
            f.g("Spielperformance beim Herstellen verbessern"),
