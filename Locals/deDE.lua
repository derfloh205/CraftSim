...
function CraftSim.LOCAL_DE:GetData()
    ...
    return {
        ...
        [CraftSim.CONST.TEXT.MATERIAL_QUALITY_BONUS_LABEL] = "Materialqualitätsbonus: ",
        [CraftSim.CONST.TEXT.MATERIAL_QUALITY_MAXIMUM_LABEL] = "Maximale Materialqualität %: ",
        ...
        [CraftSim.CONST.TEXT.MATERIALS_MISSING] = "Materialien fehlen",
        [CraftSim.CONST.TEXT.MATERIALS_AVAILABLE] = "Materialien verfügbar",
        [CraftSim.CONST.TEXT.MATERIALS_CHEAPER] = "Günstigste Materialien",
        ...
        [CraftSim.CONST.TEXT.MATERIALS_MAXIMUM_QUALITY] = "Maximale Qualität: ",
        [CraftSim.CONST.TEXT.MATERIALS_AVERAGE_PROFIT_LABEL] = "Ø Gewinn: ",
        ...
        [CraftSim.CONST.TEXT.MATERIALS_OPTIMIZE_BEST_ASSIGNED] = "Beste Reagenzien zugewiesen",
        [CraftSim.CONST.TEXT.MATERIALS_CONCENTRATION_LABEL] = "Konzentration: ",
        [CraftSim.CONST.TEXT.MATERIALS_OPTIMIZE_INFO] = "Shift + LMT auf die Zahlen, um den Gegenstandslink in den Chat einzufügen",
        [CraftSim.CONST.TEXT.MATERIALS_OPTIMIZE_BUTTON] = "Optimieren",
        ...
        [CraftSim.CONST.TEXT.CRAFT_RESULTS_LOG_1] = "Gewinn: ",
        [CraftSim.CONST.TEXT.CRAFT_RESULTS_LOG_2] = "Inspiriert!",
        [CraftSim.CONST.TEXT.CRAFT_RESULTS_LOG_3] = "Mehrfachherstellung: ",
        [CraftSim.CONST.TEXT.CRAFT_RESULTS_LOG_4] = "Ressourcen gespart!: ",
        [CraftSim.CONST.TEXT.CRAFT_RESULTS_LOG_5] = "Chance: ",
        [CraftSim.CONST.TEXT.CRAFT_RESULTS_CRAFTED_ITEMS] = "Herstellte Gegenstände",
        [CraftSim.CONST.TEXT.CRAFT_RESULTS_SESSION_PROFIT] = "Sitzungsgewinn",
        [CraftSim.CONST.TEXT.CRAFT_RESULTS_RESET_DATA] = "Daten zurücksetzen",
        [CraftSim.CONST.TEXT.CRAFT_RESULTS_EXPORT_JSON] = "JSON exportieren",
        [CraftSim.CONST.TEXT.CRAFT_RESULTS_RECIPE_STATISTICS] = "Rezeptstatistiken",
        [CraftSim.CONST.TEXT.CRAFT_RESULTS_NOTHING] = "Noch nichts hergestellt!",
        [CraftSim.CONST.TEXT.CRAFT_RESULTS_STATISTICS_1] = "Herstellungen: ",
        [CraftSim.CONST.TEXT.CRAFT_RESULTS_STATISTICS_2] = "Erwarteter Ø Gewinn: ",
        [CraftSim.CONST.TEXT.CRAFT_RESULTS_STATISTICS_3] = "Realer Ø Gewinn: ",
        [CraftSim.CONST.TEXT.CRAFT_RESULTS_STATISTICS_4] = "Realer Gewinn: ",
        [CraftSim.CONST.TEXT.CRAFT_RESULTS_STATISTICS_5] = "Procs - Real / Erwartet: ",
        [CraftSim.CONST.TEXT.CRAFT_RESULTS_STATISTICS_7] = "Mehrfachherstellung: ",
        [CraftSim.CONST.TEXT.CRAFT_RESULTS_STATISTICS_8] = "- Ø Zusätzliche Gegenstände: ",
        [CraftSim.CONST.TEXT.CRAFT_RESULTS_STATISTICS_9] = "Einfallsreichtum Procs: ",
        ...
        [CraftSim.CONST.TEXT.CRAFT_RESULTS_CRAFT_PROFITS_TAB] = "Handwerksgewinne",
	...
	[CraftSim.CONST.TEXT.COST_OPTIMIZATION_SUB_RECIPE_OPTIMIZATION] = "Unterrezept Optimierung "  .. f.bb("(experimentell)"),
	...
	[CraftSim.CONST.TEXT.COST_OPTIMIZATION_SUB_RECIPE_INCLUDE_CONCENTRATION] = "Konzentration aktivieren",
        [CraftSim.CONST.TEXT.COST_OPTIMIZATION_SUB_RECIPE_INCLUDE_CONCENTRATION_TOOLTIP] = "Wenn aktiviert, berücksichtigt " ..
	...
	[CraftSim.CONST.TEXT.STATISTICS_PROBABILITY_TABLE_TAB] = "Wahrscheinlichkeits-Tabelle",
        ...
        [CraftSim.CONST.TEXT.OPTIONS_GENERAL_DETAILED_TOOLTIP] = "Detaillierte letzte Herstellungsinformation",
	...
	[CraftSim.CONST.TEXT.OPTIONS_PERFORMANCE_RAM_CRAFTS] = "Herstellungen",
        ...
        [CraftSim.CONST.TEXT.OPTIONS_MODULES_MATERIALS] = "Materialoptimierungsmodul",
        ...
        [CraftSim.CONST.TEXT.OPTIONS_GENERAL_COIN_MONEY_FORMAT_TOOLTIP] = "Münzsymbole zur Formatierung von Geld verwenden",
        ...
        [CraftSim.CONST.TEXT.CONTROL_PANEL_MODULES_CRAFT_RESULTS_LABEL] = "Herstellungsergeb.",
        ...
        [CraftSim.CONST.TEXT.CRAFT_QUEUE_CRAFT_BUTTON_ROW_LABEL_NO_MATS] = "Keine Materialien",
	...
	"Alle Anforderungen müssen erfüllt sein, um ein Rezept herzustellen",
        ...
        [CraftSim.CONST.TEXT.CRAFT_QUEUE_RESTOCK_OPTIONS_TAB_TOOLTIP] = "Konfiguriere das Auffüllverhalten beim Importieren aus dem Rezept Scan",
