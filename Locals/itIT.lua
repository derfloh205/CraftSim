...
function CraftSim.LOCAL_IT:GetData()
    ...
    return {
        ...
        -- Nodes
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.JEWELCRAFTING_DATA.NODE_IDS.TOOLSET_MASTERY] =
        "Maestria col Set di Attrezzi", -- Ideally, it should be "Maestria col Set di Attrezzi da Gioielliere" but there is not enough space for it.
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.JEWELCRAFTING_DATA.NODE_IDS.SAVING_SLIVERS] = "Risparmio di Scheggie",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.JEWELCRAFTING_DATA.NODE_IDS.BRILLIANT_BAUBLING] = "Ninnoli Brillanti",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.JEWELCRAFTING_DATA.NODE_IDS.FACETING] = "Sfaccettatura",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.JEWELCRAFTING_DATA.NODE_IDS.AIR] = "Aria",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.JEWELCRAFTING_DATA.NODE_IDS.EARTH] = "Terra",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.JEWELCRAFTING_DATA.NODE_IDS.FIRE] = "Fuoco",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.JEWELCRAFTING_DATA.NODE_IDS.FROST] = "Gelo",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.JEWELCRAFTING_DATA.NODE_IDS.SETTING] = "Montaggio",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.JEWELCRAFTING_DATA.NODE_IDS.JEWELRY] = "Gioielli",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.JEWELCRAFTING_DATA.NODE_IDS.CARVING] = "Intaglio",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.JEWELCRAFTING_DATA.NODE_IDS.NECKLACES] = "Collane",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.JEWELCRAFTING_DATA.NODE_IDS.RINGS] = "Anelli",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.JEWELCRAFTING_DATA.NODE_IDS.IDOLS] = "Idoli",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.JEWELCRAFTING_DATA.NODE_IDS.STONE] = "Pietra",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.JEWELCRAFTING_DATA.NODE_IDS.ENTERPRISING] = "Intraprendenza",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.JEWELCRAFTING_DATA.NODE_IDS.PROSPECTING] = "Prospezione",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.JEWELCRAFTING_DATA.NODE_IDS.EXTRAVAGANCIES] = "Stravaganze",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.JEWELCRAFTING_DATA.NODE_IDS.GLASSWARE] = "Vetreria",

        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.TAILORING_DATA.NODE_IDS.TAILORING_MASTERY] = "Maestria del Sarto",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.TAILORING_DATA.NODE_IDS.CLOTH_COLLECTION] = "Collezione di Stoffe",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.TAILORING_DATA.NODE_IDS.SPARING_SEWING] = "Sartoria Parsimoniosa",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.TAILORING_DATA.NODE_IDS.SHREWD_STITCHERY] = "Cucito Accorto",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.TAILORING_DATA.NODE_IDS.TEXTILES] = "Tessuti",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.TAILORING_DATA.NODE_IDS.SPINNING] = "Filatura",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.TAILORING_DATA.NODE_IDS.WEAVING] = "Tessitura",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.TAILORING_DATA.NODE_IDS.EMBROIDERY] = "Ricami",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.TAILORING_DATA.NODE_IDS.DRACONIC_NEEDLEWORK] = "Cucitura Draconica",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.TAILORING_DATA.NODE_IDS.AZUREWEAVE_TAILORING] =
        "Sartoria con Telazzurra",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.TAILORING_DATA.NODE_IDS.AZUREWEAVING] = "Tessitura di Telazzurra",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.TAILORING_DATA.NODE_IDS.CRONOCLOTH_TAILORING] =
        "Sartoria con Cronostoffa",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.TAILORING_DATA.NODE_IDS.TIMEWEAVING] = "Tessitura del Tempo",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.TAILORING_DATA.NODE_IDS.GARMENTCRAFTING] = "Produzione di Vestiti",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.TAILORING_DATA.NODE_IDS.OUTERWEAR] = "Abbigliamenti da Esterno",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.TAILORING_DATA.NODE_IDS.GLOVES] = "Guanti",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.TAILORING_DATA.NODE_IDS.FOOTWEAR] = "Calzature",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.TAILORING_DATA.NODE_IDS.HATS] = "Cappelli",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.TAILORING_DATA.NODE_IDS.CLOAKS] = "Mantelli",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.TAILORING_DATA.NODE_IDS.OUTFITS] = "Completi",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.TAILORING_DATA.NODE_IDS.ROBES] = "Vesti",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.TAILORING_DATA.NODE_IDS.LEGGINGS] = "Gambiere",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.TAILORING_DATA.NODE_IDS.EMBELLISHMENTS] = "Abbellimenti",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.TAILORING_DATA.NODE_IDS.MANTLES] = "Coprispalle",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.TAILORING_DATA.NODE_IDS.ARMBANDS] = "Antibracci",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.TAILORING_DATA.NODE_IDS.BELTS] = "Cinture",

        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.ENGINEERING_DATA.NODE_IDS.OPTIMIZED_EFFICIENCY] =
        "Efficienza Ottimizzata",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.ENGINEERING_DATA.NODE_IDS.PIECES_PARTS] = "Pezzi di Ricambio",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.ENGINEERING_DATA.NODE_IDS.SCRAPPER] = "Riciclatore",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.ENGINEERING_DATA.NODE_IDS.GENERALIST] = "Generalista",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.ENGINEERING_DATA.NODE_IDS.EXPLOSIVES] = "Explosivi",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.ENGINEERING_DATA.NODE_IDS.CREATION] = "Creazione",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.ENGINEERING_DATA.NODE_IDS.SHORT_FUSE] = "Miccia Corta",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.ENGINEERING_DATA.NODE_IDS.EZ_THRO] = "Maneggevolezza",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.ENGINEERING_DATA.NODE_IDS.FUNCTION_OVER_FORM] =
        "Funziona prima della Forma",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.ENGINEERING_DATA.NODE_IDS.GEAR] = "Equipaggiamento",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.ENGINEERING_DATA.NODE_IDS.GEARS_FOR_GEAR] =
        "Ingranaggi per equipaggiamento",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.ENGINEERING_DATA.NODE_IDS.UTILITY] = "Utilità",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.ENGINEERING_DATA.NODE_IDS.MECHANICAL_MIND] = "Mente Meccanica",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.ENGINEERING_DATA.NODE_IDS.INVENTIONS] = "Invenzioni",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.ENGINEERING_DATA.NODE_IDS.NOVELTIES] = "Amenità",

        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.BLACKSMITHING_DATA.NODE_IDS.HAMMER_CONTROL] = "Controllo del Martello",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.BLACKSMITHING_DATA.NODE_IDS.SAFETY_SMITHING] =
        "Forgiatura in Sicurezza",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.BLACKSMITHING_DATA.NODE_IDS.POIGNANT_PLANS] = "Progetti Toccanti",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.BLACKSMITHING_DATA.NODE_IDS.SPECIALITY_SMITHING] =
        "Forgiatura Speciale",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.BLACKSMITHING_DATA.NODE_IDS.TOOLSMITHING] = "Creazione di Attrezzi",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.BLACKSMITHING_DATA.NODE_IDS.STONEWORK] = "Lavorazione della Pietra",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.BLACKSMITHING_DATA.NODE_IDS.SMELTING] = "Fonditura",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.BLACKSMITHING_DATA.NODE_IDS.WEAPON_SMITHING] = "Forgiatura di Armi",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.BLACKSMITHING_DATA.NODE_IDS.BLADES] = "Lame",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.BLACKSMITHING_DATA.NODE_IDS.HAFTED] = "Impugnatura",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.BLACKSMITHING_DATA.NODE_IDS.SHORT_BLADES] = "Lame Corte",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.BLACKSMITHING_DATA.NODE_IDS.LONG_BLADES] = "Lame Lunghe",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.BLACKSMITHING_DATA.NODE_IDS.MACES_AND_HAMMERS] = "Mazze e Martelli",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.BLACKSMITHING_DATA.NODE_IDS.AXES_PICKS_AND_POLEARMS] =
        "Asce, Picconi e Armi ad Asta",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.BLACKSMITHING_DATA.NODE_IDS.ARMOR_SMITHING] = "Forgiatura d'Armature",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.BLACKSMITHING_DATA.NODE_IDS.BELTS] = "Cinture",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.BLACKSMITHING_DATA.NODE_IDS.BREASTPLATES] = "Pettorali Corazzati",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.BLACKSMITHING_DATA.NODE_IDS.FINE_ARMOR] = "Armature di Qualità",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.BLACKSMITHING_DATA.NODE_IDS.GAUNTLETS] = "Guanti Lunghi",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.BLACKSMITHING_DATA.NODE_IDS.GREAVES] = "Gambiere Rinforzate",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.BLACKSMITHING_DATA.NODE_IDS.HELMS] = "Elmi",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.BLACKSMITHING_DATA.NODE_IDS.LARGE_PLATE_ARMOR] =
        "Armature a Piastre Grandi",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.BLACKSMITHING_DATA.NODE_IDS.PAULDRONS] = "Paraspalle",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.BLACKSMITHING_DATA.NODE_IDS.SABATONS] = "Calzari",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.BLACKSMITHING_DATA.NODE_IDS.SCULPED_ARMOR] = "Armature Scolpite",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.BLACKSMITHING_DATA.NODE_IDS.SHIELDS] = "Scudi",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.BLACKSMITHING_DATA.NODE_IDS.VAMBRACES] = "Avambracci",

        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.INSCRIPTION_DATA.NODE_IDS.RUNE_MASTERY] = "Maestria delle Rune",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.INSCRIPTION_DATA.NODE_IDS.PERFECT_PRACTICE] = "Pratica Perfetta",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.INSCRIPTION_DATA.NODE_IDS.INFINITE_DISCOVERY] = "Scoperta Infinita",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.INSCRIPTION_DATA.NODE_IDS.UNDERSTANDING_FLORA] =
        "Comprensione Floreale",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.INSCRIPTION_DATA.NODE_IDS.FLAWLESS_INKS] = "Inchiostri Impeccabili",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.INSCRIPTION_DATA.NODE_IDS.ARCHIVING] = "Archiviazione",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.INSCRIPTION_DATA.NODE_IDS.DARKMOON_MYSTERIES] = "Misteri di Lunacupa",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.INSCRIPTION_DATA.NODE_IDS.FIRE] = "Fuoco",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.INSCRIPTION_DATA.NODE_IDS.FROST] = "Gelo",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.INSCRIPTION_DATA.NODE_IDS.AIR] = "Aria",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.INSCRIPTION_DATA.NODE_IDS.EARTH] = "Terra",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.INSCRIPTION_DATA.NODE_IDS.SHARED_KNOWLEDGE] = "Conoscenza Condivisa",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.INSCRIPTION_DATA.NODE_IDS.CONTRACTS_AND_MISSIVES] =
        "Contratti e Missive",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.INSCRIPTION_DATA.NODE_IDS.DRACONIC_TREATISES] = "Trattati Draconici",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.INSCRIPTION_DATA.NODE_IDS.SCALE_SIGILS] = "Sigilli della Scaglia",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.INSCRIPTION_DATA.NODE_IDS.AZURSCALE_SIGIL] =
        "Sigillo di Scaglie Azzurre",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.INSCRIPTION_DATA.NODE_IDS.EMBERSCALE_SIGIL] =
        "Sigillo di Scaglie Ardenti",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.INSCRIPTION_DATA.NODE_IDS.SAGESCALE_SIGIL] =
        "Sigillo di Scaglie Sagge",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.INSCRIPTION_DATA.NODE_IDS.BRONZESCALE_SIGIL] =
        "Sigillo di Scaglie di Bronzo",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.INSCRIPTION_DATA.NODE_IDS.JETSCALE_SIGIL] =
        "Sigillo di Scaglie Travolgenti",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.INSCRIPTION_DATA.NODE_IDS.RUNEBINDING] = "Vincoli Runici",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.INSCRIPTION_DATA.NODE_IDS.WOODCARVING] = "Intaglio del Legno",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.INSCRIPTION_DATA.NODE_IDS.PROFESSION_TOOLS] =
        "Attrezzi della Professione",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.INSCRIPTION_DATA.NODE_IDS.STAVES] = "Bastoni",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.INSCRIPTION_DATA.NODE_IDS.RUNIC_SCRIPTURE] = "Scrittura Runica",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.INSCRIPTION_DATA.NODE_IDS.CODEXES] = "Codici",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.INSCRIPTION_DATA.NODE_IDS.VANTUS_RUNES] = "Rune Vantus",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.INSCRIPTION_DATA.NODE_IDS.FAUNA_RUNES] = "Rune Fauna",

        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.ENCHANTING_DATA.NODE_IDS.ENCHANTMENT] = "Incantamento",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.ENCHANTING_DATA.NODE_IDS.PRIMAL] = "Primordiale",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.ENCHANTING_DATA.NODE_IDS.MATERIAL_MANIPULATION] =
        "Manipolazione della Materia",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.ENCHANTING_DATA.NODE_IDS.BURNING] = "Bruciante",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.ENCHANTING_DATA.NODE_IDS.EARTHEN] = "Terrigeno",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.ENCHANTING_DATA.NODE_IDS.SOPHIC] = "Sofico",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.ENCHANTING_DATA.NODE_IDS.FROZEN] = "Gelido",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.ENCHANTING_DATA.NODE_IDS.WAFTING] = "Aleggiante",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.ENCHANTING_DATA.NODE_IDS.ADAPTIVE] = "Adattivo",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.ENCHANTING_DATA.NODE_IDS.ARTISTRY] = "Artisticità",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.ENCHANTING_DATA.NODE_IDS.MAGICAL_REINFORCEMENT] = "Rinforzo Magico",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.ENCHANTING_DATA.NODE_IDS.INSIGHT_OF_THE_BLUE] =
        "Consapevolezza del Blu",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.ENCHANTING_DATA.NODE_IDS.DRACONIC_DISENCHANTMENT] =
        "Disincanto Draconico",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.ENCHANTING_DATA.NODE_IDS.PRIMAL_EXTRACTION] = "Estrazione Primordiale",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.ENCHANTING_DATA.NODE_IDS.RODS_RUNES_AND_RUSES] =
        "Verghe, Rune e Stratagemmi",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.ENCHANTING_DATA.NODE_IDS.RODS_AND_WANDS] = "Verghe e Bacchette",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.ENCHANTING_DATA.NODE_IDS.ILLUSORY_GOODS] = "Prodotti Illusori",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.ENCHANTING_DATA.NODE_IDS.RESOURCEFUL_WRIT] = "Encomi Parsimoniosi",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.ENCHANTING_DATA.NODE_IDS.INSPIRED_DEVOTION] = "Devozione Ispirata",

        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.ALCHEMY_DATA.NODE_IDS.ALCHEMICAL_THEORY] = "Teoria Alchemica",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.ALCHEMY_DATA.NODE_IDS.TRANSMUTATION] = "Trasmutazione",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.ALCHEMY_DATA.NODE_IDS.CHEMICAL_SYNTHESIS] = "Sintesi Chimica",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.ALCHEMY_DATA.NODE_IDS.DECAYOLOGY] = "Studio del Decadimento",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.ALCHEMY_DATA.NODE_IDS.RESOURCEFUL_ROUTINES] = "Routine Parsimoniose",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.ALCHEMY_DATA.NODE_IDS.INSPIRING_AMBIENCE] = "Atmosfera Ispiratrice",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.ALCHEMY_DATA.NODE_IDS.PHIAL_MASTERY] = "Maestria nelle Fiale",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.ALCHEMY_DATA.NODE_IDS.FROST_FORMULATED_PHIALS] = "Fiale del Gelo",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.ALCHEMY_DATA.NODE_IDS.AIR_FORMULATED_PHIALS] = "Fiale dell'Aria",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.ALCHEMY_DATA.NODE_IDS.PHIAL_LORE] = "Conoscenza delle Fiale",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.ALCHEMY_DATA.NODE_IDS.PHIAL_EXPERIMENTATION] = "Fiala Sperimentale",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.ALCHEMY_DATA.NODE_IDS.PHIAL_BATCH_PRODUCTION] = "Produzione in Lotto",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.ALCHEMY_DATA.NODE_IDS.POTION_MASTERY] = "Maestria nelle Pozioni",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.ALCHEMY_DATA.NODE_IDS.FROST_FORMULATED_POTIONS] = "Pozioni del Gelo",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.ALCHEMY_DATA.NODE_IDS.AIR_FORMULATED_POTIONS] = "Pozioni dell'Aria",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.ALCHEMY_DATA.NODE_IDS.POTION_LORE] = "Conoscenza delle Pozioni",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.ALCHEMY_DATA.NODE_IDS.POTION_EXPERIMENTATION] = "Pozione Sperimentale",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.ALCHEMY_DATA.NODE_IDS.POTION_BATCH_PRODUCTION] = "Produzione in Lotto",

        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.LEATHERWORKING_DATA.NODE_IDS.LEATHERWORKING_DISCIPLINE] =
        "Disciplina di Conciatura",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.LEATHERWORKING_DATA.NODE_IDS.SHEAR_MASTERY_OF_LEATHER] =
        "Maestria del Cuoio Inaudita",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.LEATHERWORKING_DATA.NODE_IDS.AWL_INSPIRING_WORKS] =
        "Lavori Puntigliosi",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.LEATHERWORKING_DATA.NODE_IDS.BONDING_AND_STITCHING] =
        "Legatura e Cucitura",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.LEATHERWORKING_DATA.NODE_IDS.CURING_AND_TANNING] =
        "Indurimento e Tannatura",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.LEATHERWORKING_DATA.NODE_IDS.LEATHER_ARMOR_CRAFTING] =
        "Creazione di Armature di Cuoio",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.LEATHERWORKING_DATA.NODE_IDS.SHAPED_LEATHER_ARMOR] =
        "Armature di Cuoio Plasmato",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.LEATHERWORKING_DATA.NODE_IDS.EMBROIDERED_LEATHER_ARMOR] =
        "Armatura di Cuoio Ricamato",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.LEATHERWORKING_DATA.NODE_IDS.CHESTPIECES] = "Corazze",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.LEATHERWORKING_DATA.NODE_IDS.HELMS] = "Elmi",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.LEATHERWORKING_DATA.NODE_IDS.SHOULDERPADS] = "Spalletti",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.LEATHERWORKING_DATA.NODE_IDS.WRISTWRAPS] = "Bracciali Leggeri",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.LEATHERWORKING_DATA.NODE_IDS.LEGGUARDS] = "Gambali Foderati",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.LEATHERWORKING_DATA.NODE_IDS.GLOVES] = "Guanti",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.LEATHERWORKING_DATA.NODE_IDS.LEATHER_BELTS] = "Cinture",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.LEATHERWORKING_DATA.NODE_IDS.LEATHER_BOOTS] = "Stivali",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.LEATHERWORKING_DATA.NODE_IDS.MAIL_ARMOR_CRAFTING] =
        "Creazione di Armature di Maglia",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.LEATHERWORKING_DATA.NODE_IDS.LARGE_MAIL] = "Maglia Grande",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.LEATHERWORKING_DATA.NODE_IDS.INTRICATE_MAIL] = "Maglia Intricata",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.LEATHERWORKING_DATA.NODE_IDS.MAIL_SHIRTS] = "Camicie di Maglia",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.LEATHERWORKING_DATA.NODE_IDS.MAIL_HELMS] = "Elmi di Maglia",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.LEATHERWORKING_DATA.NODE_IDS.SHOULDERGUARDS] = "Spallacci Foderati",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.LEATHERWORKING_DATA.NODE_IDS.BRACES] = "Bracciali",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.LEATHERWORKING_DATA.NODE_IDS.GREAVES] = "Gambiere Rinforzate",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.LEATHERWORKING_DATA.NODE_IDS.GAUNTLETS] = "Guanti Lunghi",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.LEATHERWORKING_DATA.NODE_IDS.MAIL_BELTS] = "Cinture",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.LEATHERWORKING_DATA.NODE_IDS.MAIL_BOOTS] = "Stivali",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.LEATHERWORKING_DATA.NODE_IDS.PRIMORDIAL_LEATHERWORKING] =
        "Conciatura Primordiale",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.LEATHERWORKING_DATA.NODE_IDS.ELEMENTAL_MASTERY] =
        "Maestria Elementale",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.LEATHERWORKING_DATA.NODE_IDS.BESTIAL_PRIMACY] = "Supremazia Bestiale",
        [CraftSim.SPECIALIZATION_DATA.DRAGONFLIGHT.LEATHERWORKING_DATA.NODE_IDS.DECAYING_GRASPS] = "Stretta Decadente",
