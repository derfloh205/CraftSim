...
function CraftSim.LOCAL_FR:GetData()
    ...
    return {
        ...
        [CraftSim.CONST.TEXT.OPTIONS_TSM_DEPOSIT_ENABLED_LABEL] = "Activer le coût de dépôt estimé",
        [CraftSim.CONST.TEXT.OPTIONS_TSM_DEPOSIT_ENABLED_TOOLTIP] = "Soustrait le coût de dépôt HV estimé du calcul de profit.\nUtilise les données de prix TSM pour estimer le dépôt lors de la mise en vente.",
        [CraftSim.CONST.TEXT.OPTIONS_TSM_DEPOSIT_EXPRESSION_LABEL] = "Expression TSM pour le dépôt",
        [CraftSim.CONST.TEXT.OPTIONS_TSM_SMART_RESTOCK_ENABLED_LABEL] = "Restock intelligent (soustraire l'inventaire)",
        [CraftSim.CONST.TEXT.OPTIONS_TSM_SMART_RESTOCK_ENABLED_TOOLTIP] = "Lors de l'envoi des recettes dans la file d'artisanat, soustrait les objets\ndéjà possédés (sacs, banque, alts, banque de guilde) du nombre à restock.",
        [CraftSim.CONST.TEXT.OPTIONS_TSM_SMART_RESTOCK_INCLUDE_ALTS_LABEL] = "Inclure les personnages alternatifs",
        [CraftSim.CONST.TEXT.OPTIONS_TSM_SMART_RESTOCK_INCLUDE_WARBANK_LABEL] = "Inclure la banque de guilde",
        ...
        [CraftSim.CONST.TEXT.CRAFT_QUEUE_ADD_WORK_ORDERS_ALLOW_CONCENTRATION_CHECKBOX] = "Permettre la " .. f.gold("Concentration"),
        ...
        [CraftSim.CONST.TEXT.CRAFT_QUEUE_WORK_ORDER_TYPE_BUTTON] = "Type de commande",
        [CraftSim.CONST.TEXT.CRAFT_QUEUE_PATRON_ORDERS_BUTTON] = "Commandes de clients",
        [CraftSim.CONST.TEXT.CRAFT_QUEUE_GUILD_ORDERS_BUTTON] = "Commandes de guilde",
        [CraftSim.CONST.TEXT.CRAFT_QUEUE_PERSONAL_ORDERS_BUTTON] = "Commandes personnelles",
        [CraftSim.CONST.TEXT.CRAFT_QUEUE_GUILD_ORDERS_ALTS_ONLY_CHECKBOX] = f.r("Seulement ") .. "les rerolls",
        [CraftSim.CONST.TEXT.CRAFT_QUEUE_PATRON_ORDERS_FORCE_CONCENTRATION_CHECKBOX] = f.r("Forcer ") .. f.gold("Concentration"),
        [CraftSim.CONST.TEXT.CRAFT_QUEUE_PATRON_ORDERS_FORCE_CONCENTRATION_TOOLTIP] = "Forcer l'utilisation de la concentration pour toutes les commandes de clients si possible",
        [CraftSim.CONST.TEXT.CRAFT_QUEUE_PATRON_ORDERS_SPARK_RECIPES_CHECKBOX] = "Inclure les recettes avec " .. f.e("Étincelle"),
        [CraftSim.CONST.TEXT.CRAFT_QUEUE_PATRON_ORDERS_SPARK_RECIPES_TOOLTIP] = "Inclure les commandes nécessitant une Étincelle comme matériau",
        [CraftSim.CONST.TEXT.CRAFT_QUEUE_PATRON_ORDERS_ACUITY_CHECKBOX] = "Inclure les récompenses " .. f.bb("Acuité/Aplomb"),
        [CraftSim.CONST.TEXT.CRAFT_QUEUE_PATRON_ORDERS_ACUITY_TOOLTIP] = "Inclure les commandes avec des récompenses d'Acuité/Aplomb",
        [CraftSim.CONST.TEXT.CRAFT_QUEUE_PATRON_ORDERS_POWER_RUNE_CHECKBOX] = "Inclure les récompenses " .. f.bb("Rune d'augmentation"),
        [CraftSim.CONST.TEXT.CRAFT_QUEUE_PATRON_ORDERS_POWER_RUNE_TOOLTIP] = "Inclure les commandes avec des récompenses de Rune d'augmentation",
        [CraftSim.CONST.TEXT.CRAFT_QUEUE_PATRON_ORDERS_KNOWLEDGE_POINTS_CHECKBOX] = "Inclure les récompenses " .. f.bb("Points de connaissance"),
        [CraftSim.CONST.TEXT.CRAFT_QUEUE_PATRON_ORDERS_KNOWLEDGE_POINTS_TOOLTIP] = "Inclure les commandes avec des récompenses de Points de connaissance",
