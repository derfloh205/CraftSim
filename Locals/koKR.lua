...
function CraftSim.LOCAL_KO:GetData()
    ...
    return {
        ...
        CRAFT_QUEUE_RESTOCK_FAVORITES_AUTO_SHOPPING_LIST = "대기열 작업 후 자동으로 쇼핑 목록 생성",
...
설정한 판매율 임계값보다 크거나 같은지 확인합니다.
        ...
        CRAFT_QUEUE_RESTOCK_FAVORITES_OPTIONS_AUTO_SHOPPING_LIST = "활성화하면 대기열 작업 후 자동으로 쇼핑 리스트를 생성합니다.",
        ...
        CRAFT_LISTS_RESTOCK_SUBTRACT_OWNED_LABEL = "제작 목록 재입고: 가방·은행·전쟁 금고·경매장 보유량 차감",
        CRAFT_LISTS_RESTOCK_SUBTRACT_OWNED_TOOLTIP =
        "켜면 재입고 목표에서 가방·은행·전쟁 금고·경매장 보유량을 뺀 만큼만 대기열에 넣습니다.\n\n"
            .. "이미 목표 이상이면 대기열에 넣지 않습니다.\n\n"
            .. "끄면 보유 여부와 관계없이 목표 수량만큼 대기열에 넣습니다.",
        CRAFT_LISTS_OPTIONS_AUTO_SHOPPING_LIST = "대기열 작업 후 자동으로 쇼핑 리스트 생성",
