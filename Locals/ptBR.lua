...
function CraftSim.LOCAL_PT:GetData()
    ...
    return {
        ...
        [CraftSim.CONST.TEXT.CRAFT_RESULTS_STATISTICS_TRACKER_TAB] = "Rastreador de Estatísticas",
...
maior ou igual ao limite de taxa de venda configurado.
        ...
        [CraftSim.CONST.TEXT.CRAFT_QUEUE_ORDER_INFO_REAGENTS_IN_YOUR_INVENTORY] = f.r(
            "\n\nTodos os reagentes fornecidos devem estar em seu inventário para criar uma ordem de serviço!"),
