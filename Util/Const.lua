...
CraftSim.CONST.TEXT = {
    ...
    OPTIONS_MODULES_TAB = 72, 
    OPTIONS_PROFIT_CALCULATION_TAB = 73,
    OPTIONS_CRAFTING_TAB = 74,
    OPTIONS_TSM_RESET = 75,
    OPTIONS_MODULES_TRANSPARENCY = 76,
    OPTIONS_MODULES_MATERIALS = 77,
    OPTIONS_MODULES_AVERAGE_PROFIT = 78,
    OPTIONS_MODULES_TOP_GEAR = 79,
    OPTIONS_MODULES_COST_OVERVIEW = 80,
    OPTIONS_MODULES_SPECIALIZATION_INFO = 81,
    OPTIONS_PROFIT_CALCULATION_OFFSET = 82,
    OPTIONS_PROFIT_CALCULATION_OFFSET_TOOLTIP = 83,
    OPTIONS_PROFIT_CALCULATION_MULTICRAFT_CONSTANT = 84,
    OPTIONS_PROFIT_CALCULATION_MULTICRAFT_CONSTANT_EXPLANATION = 52,
    OPTIONS_PROFIT_CALCULATION_RESOURCEFULNESS_CONSTANT = 85,
    OPTIONS_PROFIT_CALCULATION_RESOURCEFULNESS_CONSTANT_EXPLANATION = 53,
    ...
    CUSTOMER_SERVICE_LIVE_PREVIEW_EXPLANATION = 560,
    CUSTOMER_SERVICE_HIGHEST_GUARANTEED_CHECKBOX_EXPLANATION = 561,
