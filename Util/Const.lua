...
CraftSim.CONST.GENERAL_OPTIONS = {
    ...
    --- When true, craft list restock target subtracts items you already have (bags, bank, warbank per CraftSim item count).
    CRAFT_LISTS_RESTOCK_SUBTRACT_OWNED = "CRAFT_LISTS_RESTOCK_SUBTRACT_OWNED",
...
CraftSim.CONST.GENERAL_OPTIONS_DEFAULTS = {
    ...
    [CraftSim.CONST.GENERAL_OPTIONS.CRAFT_LISTS_RESTOCK_SUBTRACT_OWNED] = true,
