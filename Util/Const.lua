...
---@enum CraftSim.PROFESSIONS_TAB
CraftSim.CONST.PROFESSIONS_TAB = {
    RECIPE = "RECIPE",
    SPEC_INFO = "SPEC_INFO",
...
CraftSim.CONST.GENERAL_OPTIONS = {
    ...
    PATCH_NOTES_CHECKSUM = "PATCH_NOTES_CHECKSUM",
    ...
    SHOW_TUTORIAL_BUTTONS = "SHOW_TUTORIAL_BUTTONS",

    -- TOOLTIP (item tooltips)
    --- When true, item tooltips list CraftSim-registered characters who know a recipe for that item.
    SHOW_REGISTERED_CRAFTERS_ITEM_TOOLTIP = "SHOW_REGISTERED_CRAFTERS_ITEM_TOOLTIP",
    --- Max crafter names shown on that line; additional crafters are summarized as a count.
    REGISTERED_CRAFTERS_ITEM_TOOLTIP_MAX = "REGISTERED_CRAFTERS_ITEM_TOOLTIP_MAX",
    ...
    RECIPESCAN_INV_COUNT_INCLUDE_ALTS = "RECIPESCAN_INV_COUNT_INCLUDE_ALTS",
    ...
    CRAFTQUEUE_WORK_ORDERS_AUTO_QUEUE = "CRAFTQUEUE_WORK_ORDERS_AUTO_QUEUE",
    CRAFTQUEUE_WORK_ORDERS_OPTIMIZE_FINISHING_REAGENTS = "CRAFTQUEUE_WORK_ORDERS_OPTIMIZE_FINISHING_REAGENTS",
    ...
    RECIPESCAN_ONLY_CRAFTLISTS = "RECIPESCAN_ONLY_CRAFTLISTS",
    RECIPESCAN_CRAFTLIST_SCAN_SELECTED = "RECIPESCAN_CRAFTLIST_SCAN_SELECTED",
    ...
    --- When true, recompute and persist patron moxie values on Auctionator DB updates (changed values only).
    CRAFTQUEUE_QUEUE_PATRON_ORDERS_AUTO_UPDATE_MOXIE_VALUES = "CRAFTQUEUE_QUEUE_PATRON_ORDERS_AUTO_UPDATE_MOXIE_VALUES",
    --- When true, patron order profit / max-cost checks treat owned reagents as zero cost (shared pool per queue batch).
    CRAFTQUEUE_QUEUE_PATRON_ORDERS_SKIP_OWNED_MATERIAL_COSTS =
    "CRAFTQUEUE_QUEUE_PATRON_ORDERS_SKIP_OWNED_MATERIAL_COSTS",
    CRAFTQUEUE_AUTO_SHOW = "CRAFTQUEUE_AUTO_SHOW",
    --- When true, Craft Queue list / Clear / shopping list only include the logged-in character.
    CRAFTQUEUE_SHOW_CURRENT_CHARACTER_ONLY = "CRAFTQUEUE_SHOW_CURRENT_CHARACTER_ONLY",
    CRAFTQUEUE_AUTO_SHOPPING_LIST = "CRAFTQUEUE_AUTO_SHOPPING_LIST",
    ...
    CRAFTQUEUE_TWW_ENCHANT_SHATTER_FORCE_BUFF = "CRAFTQUEUE_TWW_ENCHANT_SHATTER_FORCE_BUFF",
    CRAFTQUEUE_TWW_ENCHANT_SHATTER_MOTE_ITEMID = "CRAFTQUEUE_TWW_ENCHANT_SHATTER_MOTE_ITEMID",
    --- Blacksmithing Everburning Ignition (stats / future queue integration).
    CRAFTQUEUE_EVERBURNING_IGNITION_FORCE_BUFF = "CRAFTQUEUE_EVERBURNING_IGNITION_FORCE_BUFF",
    ...
    -- RECIPE INFO
    RECIPE_INFO_DISPLAY_OPTIONS = "RECIPE_INFO_DISPLAY_OPTIONS",
    ...
    -- WORK ORDER TRACKER
    WORK_ORDER_TRACKER_AUTO_SNAPSHOT = "WORK_ORDER_TRACKER_AUTO_SNAPSHOT",
    WORK_ORDER_TRACKER_USE_CONCENTRATION = "WORK_ORDER_TRACKER_USE_CONCENTRATION",
    WORK_ORDER_TRACKER_SORT_MODE = "WORK_ORDER_TRACKER_SORT_MODE",
    WORK_ORDER_TRACKER_FILTERED_STATUS = "WORK_ORDER_TRACKER_FILTERED_STATUS",

    -- DEBUG
    DEBUG_MINIMUM_LOG_LEVEL = "DEBUG_MINIMUM_LOG_LEVEL",
    EVENT_DEV_TOOL_LOGGING_ENABLED = "EVENT_DEV_TOOL_LOGGING_ENABLED",
    DEBUG_VISIBLE = "DEBUG_VISIBLE",
    DEBUG_AUTO_SCROLL = "DEBUG_AUTO_SCROLL",

    -- DISENCHANTING
    DISENCHANT_MIN_ILVL = "DISENCHANT_MIN_ILVL",
    DISENCHANT_BLACKLIST = "DISENCHANT_BLACKLIST",

    -- BANKING
    BANKING_MAX_ITEMS_PER_FRAME = "BANKING_MAX_ITEMS_PER_FRAME",
}
...
CraftSim.CONST.GENERAL_OPTIONS_DEFAULTS = {
    ...
    [CraftSim.CONST.GENERAL_OPTIONS.PATCH_NOTES_CHECKSUM] = nil,
    ...
    [CraftSim.CONST.GENERAL_OPTIONS.INVENTORY_SOURCE] = nil, -- will be set on init
    ...
    [CraftSim.CONST.GENERAL_OPTIONS.SHOW_TUTORIAL_BUTTONS] = true,
    ...
    [CraftSim.CONST.GENERAL_OPTIONS.RECIPE_INFO_DISPLAY_OPTIONS] = {},
    ...
    [CraftSim.CONST.GENERAL_OPTIONS.RECIPESCAN_INV_COUNT_INCLUDE_ALTS] = false,
    ...
    [CraftSim.CONST.GENERAL_OPTIONS.CRAFTQUEUE_WORK_ORDERS_AUTO_QUEUE] = false,
    [CraftSim.CONST.GENERAL_OPTIONS.CRAFTQUEUE_WORK_ORDERS_OPTIMIZE_FINISHING_REAGENTS] = true,
    [CraftSim.CONST.GENERAL_OPTIONS.CRAFTQUEUE_WORK_ORDERS_FINISHING_REAGENTS_INCLUDE_SOULBOUND] = false,
    ...
    [CraftSim.CONST.GENERAL_OPTIONS.RECIPESCAN_ONLY_CRAFTLISTS] = false,
    [CraftSim.CONST.GENERAL_OPTIONS.RECIPESCAN_CRAFTLIST_SCAN_SELECTED] = {},
    ...
    -- Legacy: values now live in CraftSimDB.patronMoxieValuesDB (see DB/patronMoxieValuesDB.lua); default kept for OPTIONS:Get.
    [CraftSim.CONST.GENERAL_OPTIONS.CRAFTQUEUE_QUEUE_PATRON_ORDERS_MOXIE_VALUES] = {},
    [CraftSim.CONST.GENERAL_OPTIONS.CRAFTQUEUE_QUEUE_PATRON_ORDERS_AUTO_UPDATE_MOXIE_VALUES] = false,
    [CraftSim.CONST.GENERAL_OPTIONS.CRAFTQUEUE_QUEUE_PATRON_ORDERS_SKIP_OWNED_MATERIAL_COSTS] = false,
    [CraftSim.CONST.GENERAL_OPTIONS.CRAFTQUEUE_AUTO_SHOW] = true,
    [CraftSim.CONST.GENERAL_OPTIONS.CRAFTQUEUE_SHOW_CURRENT_CHARACTER_ONLY] = false,
    [CraftSim.CONST.GENERAL_OPTIONS.CRAFTQUEUE_AUTO_SHOPPING_LIST] = false,
    ...
    [CraftSim.CONST.GENERAL_OPTIONS.CRAFTQUEUE_TWW_ENCHANT_SHATTER_FORCE_BUFF] = false,
    [CraftSim.CONST.GENERAL_OPTIONS.CRAFTQUEUE_TWW_ENCHANT_SHATTER_MOTE_ITEMID] = nil,
    [CraftSim.CONST.GENERAL_OPTIONS.CRAFTQUEUE_EVERBURNING_IGNITION_FORCE_BUFF] = false,
    ...
    --- WORK ORDER TRACKER
    [CraftSim.CONST.GENERAL_OPTIONS.WORK_ORDER_TRACKER_AUTO_SNAPSHOT] = true,
    [CraftSim.CONST.GENERAL_OPTIONS.WORK_ORDER_TRACKER_USE_CONCENTRATION] = true,
    [CraftSim.CONST.GENERAL_OPTIONS.WORK_ORDER_TRACKER_SORT_MODE] = "TIME",
    [CraftSim.CONST.GENERAL_OPTIONS.WORK_ORDER_TRACKER_FILTERED_STATUS] = {
        READY = true,
        IN_PROGRESS = true,
        NEEDS_REAGENTS = true,
        NEEDS_QUALITY = true,
    ...
    -- DEBUG
    [CraftSim.CONST.GENERAL_OPTIONS.DEBUG_MINIMUM_LOG_LEVEL] = CraftSim.LibLog.LogLevel.ERROR,
    [CraftSim.CONST.GENERAL_OPTIONS.EVENT_DEV_TOOL_LOGGING_ENABLED] = false,
    [CraftSim.CONST.GENERAL_OPTIONS.DEBUG_VISIBLE] = false,
    [CraftSim.CONST.GENERAL_OPTIONS.DEBUG_AUTO_SCROLL] = true,

    -- DISENCHANTING
    [CraftSim.CONST.GENERAL_OPTIONS.DISENCHANT_MIN_ILVL] = 100,
    [CraftSim.CONST.GENERAL_OPTIONS.DISENCHANT_BLACKLIST] = {},

    -- BANKING
    [CraftSim.CONST.GENERAL_OPTIONS.BANKING_MAX_ITEMS_PER_FRAME] = 2,
}
...
CraftSim.CONST.PRE_CRAFT_BUFF_GATE_ID = {
