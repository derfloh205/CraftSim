...
CraftSim.CONST.GENERAL_OPTIONS_DEFAULTS = {
    ...
    [CraftSim.CONST.GENERAL_OPTIONS.RECIPESCAN_SEND_TO_CRAFTQUEUE_TSM_SALERATE_THRESHOLD] = 1,
...
CraftSim.CONST.TEXT = {
    ...
    CRAFT_QUEUE_ORDER_INFO_REAGENTS_IN_YOUR_INVENTORY = "CRAFT_QUEUE_ORDER_INFO_REAGENTS_IN_YOUR_INVENTORY",
