...
CraftSim.CONST.GENERAL_OPTIONS_DEFAULTS = {
    ...
    -- TSM
    [CraftSim.CONST.GENERAL_OPTIONS.TSM_PRICE_KEY_MATERIALS] = "first(DBRecent, DBMinbuyout)",
    [CraftSim.CONST.GENERAL_OPTIONS.TSM_PRICE_KEY_ITEMS] = "first(DBRecent, DBMinbuyout)",
    -- TOP GEAR
    ...
    [CraftSim.CONST.GENERAL_OPTIONS.RECIPESCAN_SCAN_MODE] = CraftSim.RECIPE_SCAN.SCAN_MODES.OPTIMIZE,
