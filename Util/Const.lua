...
CraftSim.CONST.TEXT = {
    ...
    MATERIALS_MAXIMUM_QUALITY = "MATERIALS_MAXIMUM_QUALITY",
    MATERIALS_AVERAGE_PROFIT_LABEL = "MATERIALS_AVERAGE_PROFIT_LABEL",
    MATERIALS_AVERAGE_PROFIT_TOOLTIP = "MATERIALS_AVERAGE_PROFIT_TOOLTIP",
    MATERIALS_CONCENTRATION_LABEL = "MATERIALS_CONCENTRATION_LABEL",
    MATERIALS_OPTIMIZE_BUTTON = "MATERIALS_OPTIMIZE_BUTTON",
    MATERIALS_OPTIMIZE_TOOLTIP = "MATERIALS_OPTIMIZE_TOOLTIP",
    MATERIALS_OPTIMIZE_BEST_ASSIGNED = "MATERIALS_OPTIMIZE_BEST_ASSIGNED",
    MATERIALS_OPTIMIZE_INFO = "MATERIALS_OPTIMIZE_INFO",
