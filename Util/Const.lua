...
CraftSim.CONST.TEXT = {
    ...
    OPTIONS_PROFIT_CALCULATION_OFFSET = 96,
    OPTIONS_PROFIT_CALCULATION_OFFSET_TOOLTIP = 97,
    OPTIONS_PROFIT_CALCULATION_MULTICRAFT_CONSTANT = 98,
    OPTIONS_PROFIT_CALCULATION_MULTICRAFT_CONSTANT_EXPLANATION = 99,
    OPTIONS_PROFIT_CALCULATION_RESOURCEFULNESS_CONSTANT = 100,
    OPTIONS_PROFIT_CALCULATION_RESOURCEFULNESS_CONSTANT_EXPLANATION = 101,
