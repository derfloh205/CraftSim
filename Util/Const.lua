...
CraftSim.CONST.TEXT = {
    ...
    PROBABILITY_TABLE_EXPLANATION = 62,
    SPEC_INFO_NODE_TOOLTIP = 63,
    SPEC_INFO_WORK_IN_PROGRESS = 64,
    SIMULATE_KNOWLEDGE_DISTRIBUTION = 65,
    ...
    SPEC_INFO_TITLE = 130,
    CRAFT_RESULTS_TITLE = 131,
    MATERIALS_TITLE = 132,
    
    STAT_WEIGHTS_TITLE = 140,
    STAT_WEIGHTS_EXPLANATION_TITLE = 141,
    STAT_WEIGHTS_SHOW_EXPLANATION_BUTTON = 142,
    STAT_WEIGHTS_HIDE_EXPLANATION_BUTTON = 143,
    STAT_WEIGHTS_SHOW_STATISTICS_BUTTON = 144,
    STAT_WEIGHTS_HIDE_STATISTICS_BUTTON = 145,
    STAT_WEIGHTS_PROFIT_CRAFT = 146,
    STAT_WEIGHTS_PROFIT_EXPLANATION_TAB = 147,
    STAT_WEIGHTS_PROFIT_EXPLANATION_HSV_TAB = 148,
    STAT_WEIGHTS_PROFIT_EXPLANATION = 149,
    STAT_WEIGHTS_PROFIT_EXPLANATION_HSV = 150,

    COST_DETAILS_TITLE = 160,

    CRAFT_DATA_TITLE = 170,

    STATISTICS_TITLE = 180,

    CUSTOMER_SERVICE_TITLE = 190,
    CUSTOMER_SERVICE_RECIPE_WHISPER = 191,
    CUSTOMER_SERVICE_LIVE_PREVIEW = 192,
    CUSTOMER_SERVICE_WHISPER = 193,
    CUSTOMER_SERVICE_MESSAGE_FORMAT = 194,
    CUSTOMER_SERVICE_RESET_TO_DEFAULT = 195,
    CUSTOMER_SERVICE_ALLOW_CONNECTIONS = 196,
    CUSTOMER_SERVICE_SEND_INVITE = 197,

    PRICE_DETAILS_TITLE = 200,

    PRICE_OVERRIDE_TITLE = 210,

    RECIPE_SCAN_TITLE = 220,
    RECIPE_SCAN_MODE = 221,
    RECIPE_SCAN_SCAN_RECIPIES = 222,
    RECIPE_SCAN_INCLUDE_NOT_LEARNED = 223,
    RECIPE_SCAN_INCLUDE_NOT_LEARNED_TOOLTIP = 224,
    RECIPE_SCAN_INCLUDE_SOULBOUND = 225,
    RECIPE_SCAN_INCLUDE_SOULBOUND_TOOLTIP = 226,
    RECIPE_SCAN_INCLUDE_GEAR = 227,
    RECIPE_SCAN_INCLUDE_GEAR_TOOLTIP = 228,
    RECIPE_SCAN_OPTIMIZE_TOOLS = 229,
    RECIPE_SCAN_OPTIMIZE_TOOLS_TOOLTIP = 230,
    RECIPE_SCAN_OPTIMIZE_TOOLS_WARNING = 231,

    TOP_GEAR_TITLE = 240,
    TOP_GEAR_AUTOMATIC = 241,
    TOP_GEAR_AUTOMATIC_TOOLTIP = 242,
    TOP_GEAR_SIMULATE = 243,
    TOP_GEAR_EQUIP = 244,
    TOP_GEAR_SIMULATE_QUALITY = 245,
    TOP_GEAR_SIMULATE_EQUIPPED = 246,
    TOP_GEAR_SIMULATE_PROFIT_DIFFERENCE = 247,
    TOP_GEAR_SIMULATE_NEW_MUTLICRAFT = 248,
    TOP_GEAR_SIMULATE_NEW_CRAFTING_SPEED = 249,
    TOP_GEAR_SIMULATE_NEW_RESOURCEFULNESS = 250,
    TOP_GEAR_SIMULATE_NEW_INSPIRATION = 251,
    TOP_GEAR_SIMULATE_NEW_SKILL = 252,
    TOP_GEAR_SIMULATE_UNHANDLED = 253,
    TOP_GEAR_SIM_MODES_PROFIT = 254,
    TOP_GEAR_SIM_MODES_SKILL = 255,
    TOP_GEAR_SIM_MODES_INSPIRATION = 256,
    TOP_GEAR_SIM_MODES_MULTICRAFT = 257,
    TOP_GEAR_SIM_MODES_RESOURCEFULNESS = 258,
    TOP_GEAR_SIM_MODES_CRAFTING_SPEED = 259,
}
