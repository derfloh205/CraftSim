...
CraftSim.CONST.TEXT = {
    ...
    CRAFT_RESULTS_CRAFT_PROFITS_TAB = "CRAFT_RESULTS_CRAFT_PROFITS_TAB",
    CRAFT_RESULTS_STATISTICS_TRACKER_TAB = "CRAFT_RESULTS_STATISTICS_TRACKER_TAB",
    CRAFT_RESULTS_STATISTICS_TRACKER_TAB_DISTRIBUTION_LABEL = "CRAFT_RESULTS_STATISTICS_TRACKER_TAB_DISTRIBUTION_LABEL",
    CRAFT_RESULTS_STATISTICS_TRACKER_TAB_DISTRIBUTION_HELP = "CRAFT_RESULTS_STATISTICS_TRACKER_TAB_DISTRIBUTION_HELP",
    CRAFT_RESULTS_STATISTICS_TRACKER_TAB_MULTICRAFT = "CRAFT_RESULTS_STATISTICS_TRACKER_TAB_MULTICRAFT",
    CRAFT_RESULTS_STATISTICS_TRACKER_TAB_RESOURCEFULNESS = "CRAFT_RESULTS_STATISTICS_TRACKER_TAB_RESOURCEFULNESS",
    CRAFT_RESULTS_STATISTICS_TRACKER_TAB_YIELD_DDISTRIBUTION = "CRAFT_RESULTS_STATISTICS_TRACKER_TAB_YIELD_DDISTRIBUTION",
