...
function CraftSim.FRAME:RestoreModulePositions()
    ...
    -- local profitDetailsFrame = CraftSim.GGUI:GetFrame(CraftSim.CONST.FRAMES.PROFIT_DETAILS)
    -- local profitDetailsFrameWO = CraftSim.GGUI:GetFrame(CraftSim.CONST.FRAMES.PROFIT_DETAILS_WORK_ORDER)
