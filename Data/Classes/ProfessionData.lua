...
function CraftSim.ProfessionData:new(recipeID)
	...
	if not self.professionInfo or not self.professionInfo.profession then
		...
		if self.professionInfo.profession then
			...
			CraftSim.CACHE:AddCacheEntryByVersion(CraftSimProfessionInfoCache, self.professionInfo.profession,
				self.professionInfo)
			CraftSim.CACHE:AddCacheEntryByVersion(CraftSimProfessionSkillLineIDCache, self.professionInfo.profession,
				self.skillLineID)
		end
	end
