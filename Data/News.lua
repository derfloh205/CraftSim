...
function CraftSim.NEWS:GET_NEWS(itemMap)
    ...
    local news = {
        ...
        f.pg .. f.bb("TSM Integration"),
        f.a .. "- Added TSM specific smart restock options (send2craftqueue)",
        f.a .. "- Added TSM specific deposit cost consideration option",
        ...
        newP("21.2.1"),
        f.pg .. "Simulation Mode Bug Fix",
        f.pg .. "Concentration Curve Data Update for 12.0.1.66192",
        newP("21.2.0"),
        ...
        f.a .. "- Added TSM specific account wide inventory count",
        collab("https://github.com/muspy42"),
        newP("21.0.1"),
